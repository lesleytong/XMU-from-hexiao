...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.LoopPath} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopPathItemProvider extends PathItemProvider {
	/**
	 ...
	 * @generated
	 */
	public LoopPathItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LoopPath_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LoopPath_operator_feature", "_UI_LoopPath_type"),
				 Xmu2corePackage.Literals.LOOP_PATH__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.LOOP_PATH__ITERATOR);
			childrenFeatures.add(Xmu2corePackage.Literals.LOOP_PATH__BODY);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LoopPath"));
	}
	...
	public String getText(Object object) {
		LoopOperator labelValue = ((LoopPath)object).getOperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_LoopPath_type") :
			getString("_UI_LoopPath_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LoopPath.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Xmu2corePackage.Literals.LOOP_PATH__ITERATOR,
