...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.DeleteLinkStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeleteLinkStatementItemProvider extends StatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DeleteLinkStatementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeleteLinkStatement_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeleteLinkStatement_source_feature", "_UI_DeleteLinkStatement_type"),
				 Xmu2corePackage.Literals.DELETE_LINK_STATEMENT__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeleteLinkStatement_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeleteLinkStatement_feature_feature", "_UI_DeleteLinkStatement_type"),
				 Xmu2corePackage.Literals.DELETE_LINK_STATEMENT__FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.DELETE_LINK_STATEMENT__TARGET);
		}
	...
	/**
	 * This returns DeleteLinkStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeleteLinkStatement"));
	}
	...
	public String getText(Object object) {
		return ((EObject)object).eContainmentFeature().getName() + " -> "+getString("_UI_DeleteLinkStatement_type");
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == Xmu2corePackage.Literals.DELETE_LINK_STATEMENT__TARGET;
