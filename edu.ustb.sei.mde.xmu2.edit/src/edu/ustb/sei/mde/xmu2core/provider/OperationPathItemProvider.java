...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.OperationPath} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationPathItemProvider extends PathItemProvider {
	/**
	 ...
	 * @generated
	 */
	public OperationPathItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationPath_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationPath_operation_feature", "_UI_OperationPath_type"),
				 Xmu2corePackage.Literals.OPERATION_PATH__OPERATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.OPERATION_PATH__PARAMETERS);
		}
	...
	/**
	 * This returns OperationPath.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperationPath"));
	}
	...
	public String getText(Object object) {
		String label = ((OperationPath)object).getOperation();
		return label == null || label.length() == 0 ?
			getString("_UI_OperationPath_type") :
			getString("_UI_OperationPath_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationPath.class)) {
			case Xmu2corePackage.OPERATION_PATH__OPERATION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Xmu2corePackage.OPERATION_PATH__PARAMETERS:
