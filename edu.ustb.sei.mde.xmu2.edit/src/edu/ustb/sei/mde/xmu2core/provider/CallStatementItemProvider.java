...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.CallStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallStatementItemProvider extends StatementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CallStatement_callable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CallStatement_callable_feature", "_UI_CallStatement_type"),
				 Xmu2corePackage.Literals.CALL_STATEMENT__CALLABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.CALL_STATEMENT__PARAMETERS);
			childrenFeatures.add(Xmu2corePackage.Literals.CALL_STATEMENT__UPDATED_PARAMETERS);
		}
	...
	public String getText(Object object) {
		return ((EObject)object).eContainmentFeature().getName() + " -> "+ getString("_UI_CallStatement_type");
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Xmu2corePackage.Literals.CALL_STATEMENT__PARAMETERS ||
			childFeature == Xmu2corePackage.Literals.CALL_STATEMENT__UPDATED_PARAMETERS;
