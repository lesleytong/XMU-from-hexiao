...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.MultiplicativeExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiplicativeExpressionItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiplicativeExpression_operators_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiplicativeExpression_operators_feature", "_UI_MultiplicativeExpression_type"),
				 Xmu2corePackage.Literals.MULTIPLICATIVE_EXPRESSION__OPERATORS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.MULTIPLICATIVE_EXPRESSION__OPERANDS);
		}
