...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.AdditiveExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdditiveExpressionItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdditiveExpression_operators_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdditiveExpression_operators_feature", "_UI_AdditiveExpression_type"),
				 Xmu2corePackage.Literals.ADDITIVE_EXPRESSION__OPERATORS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.ADDITIVE_EXPRESSION__OPERANDS);
		}
