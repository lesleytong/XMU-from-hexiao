...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.Callable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallableItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Callable_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Callable_parameters_feature", "_UI_Callable_type"),
				 Xmu2corePackage.Literals.CALLABLE__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.CALLABLE__VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Xmu2corePackage.Literals.CALLABLE__VARIABLES,
