...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.Transformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformationItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transformation_packages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transformation_packages_feature", "_UI_Transformation_type"),
				 Xmu2corePackage.Literals.TRANSFORMATION__PACKAGES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Xmu2corePackage.Literals.TRANSFORMATION__DECLARED_TYPES,
				 Xmu2coreFactory.eINSTANCE.createOclCollectionType()));
