...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.PositionPath} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PositionPathItemProvider extends PathItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PositionPathItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PositionPath_operator_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PositionPath_operator_feature", "_UI_PositionPath_type"),
				 Xmu2corePackage.Literals.POSITION_PATH__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.POSITION_PATH__VALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PositionPath"));
	}
	...
	public String getText(Object object) {
		PositionOperator labelValue = ((PositionPath)object).getOperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PositionPath_type") :
			getString("_UI_PositionPath_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PositionPath.class)) {
