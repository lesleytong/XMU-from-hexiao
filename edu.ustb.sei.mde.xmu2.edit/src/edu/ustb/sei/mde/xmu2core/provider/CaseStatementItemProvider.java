...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.CaseStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseStatementItemProvider extends StatementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Xmu2corePackage.Literals.CASE_STATEMENT__CLAUSES);
		}
	...
	public String getText(Object object) {
		DomainTag labelValue = ((CaseStatement)object).getTag();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
				((EObject)object).eContainmentFeature().getName() + " -> "+getString("_UI_CaseStatement_type") :
					((EObject)object).eContainmentFeature().getName() + " -> "+getString("_UI_CaseStatement_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(Xmu2corePackage.Literals.CASE_STATEMENT__CLAUSES,
				 Xmu2coreFactory.eINSTANCE.createCasePatternClause()));
