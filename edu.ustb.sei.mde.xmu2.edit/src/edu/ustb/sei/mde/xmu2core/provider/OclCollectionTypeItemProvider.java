...
/**
 * This is the item provider adapter for a {@link edu.ustb.sei.mde.xmu2core.OclCollectionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OclCollectionTypeItemProvider extends ItemProviderAdapter {
	/**
	...
	protected void addElementtypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OclCollectionType_elementtype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OclCollectionType_elementtype_feature", "_UI_OclCollectionType_type"),
				 Xmu2corePackage.Literals.OCL_COLLECTION_TYPE__ELEMENTTYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OclCollectionType"));
	}
	...
	public String getText(Object object) {
		String label = ((OclCollectionType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OclCollectionType_type") :
			getString("_UI_OclCollectionType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OclCollectionType.class)) {
			case Xmu2corePackage.OCL_COLLECTION_TYPE__NAME:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__INSTANCE_CLASS_NAME:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__INSTANCE_CLASS:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__DEFAULT_VALUE:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__INSTANCE_TYPE_NAME:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__ABSTRACT:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__INTERFACE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Xmu2corePackage.OCL_COLLECTION_TYPE__EANNOTATIONS:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__ETYPE_PARAMETERS:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__EOPERATIONS:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__ESTRUCTURAL_FEATURES:
			case Xmu2corePackage.OCL_COLLECTION_TYPE__EGENERIC_SUPER_TYPES:
