...
/**
 * A IXmuReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IXmuReferenceResolverSwitch extends edu.ustb.sei.mde.xmu.resource.xmu.IXmuConfigurable {
