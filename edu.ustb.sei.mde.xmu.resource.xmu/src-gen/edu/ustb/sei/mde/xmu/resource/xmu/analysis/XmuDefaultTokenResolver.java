 ...
 */
public class XmuDefaultTokenResolver implements edu.ustb.sei.mde.xmu.resource.xmu.IXmuTokenResolver {
	 ...
	 */
	public XmuDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public XmuDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, edu.ustb.sei.mde.xmu.resource.xmu.IXmuTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuGrammarInformationProvider.INSTANCE.getKeywords()) {
