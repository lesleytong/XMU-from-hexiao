...
/**
 * A XmuLayoutInformationAdapter is used to store layout information that is found
 ...
 * XmuLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class XmuLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation> layoutInformations = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation>();
	...
	public java.util.List<edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation layoutInformation) {
