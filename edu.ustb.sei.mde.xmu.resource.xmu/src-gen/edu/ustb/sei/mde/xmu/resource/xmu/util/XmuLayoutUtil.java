...
public class XmuLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuSyntaxElement syntaxElement = edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuPlaceholder) {
			edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuPlaceholder placeholder = (edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuPlaceholder) syntaxElement;
			edu.ustb.sei.mde.xmu.resource.xmu.IXmuTokenResolver tokenResolver = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			edu.ustb.sei.mde.xmu.resource.xmu.IXmuTokenResolveResult result = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
