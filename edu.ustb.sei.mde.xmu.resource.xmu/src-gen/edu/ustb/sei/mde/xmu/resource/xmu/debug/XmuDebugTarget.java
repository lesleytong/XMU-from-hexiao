...
public class XmuDebugTarget extends edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugElement implements org.eclipse.debug.core.model.IDebugTarget, edu.ustb.sei.mde.xmu.resource.xmu.debug.IXmuDebugEventListener {
	
	/**
	 * associated system process
	 */
	private edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugProcess process;
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<edu.ustb.sei.mde.xmu.resource.xmu.debug.IXmuDebugEventListener> eventListeners = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.debug.IXmuDebugEventListener>();
	
	private edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((edu.ustb.sei.mde.xmu.resource.xmu.debug.IXmuDebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public XmuDebugTarget(edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(edu.ustb.sei.mde.xmu.resource.xmu.debug.IXmuDebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(edu.ustb.sei.mde.xmu.resource.xmu.debug.IXmuDebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuLineBreakpoint lineBreakpoint = (edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuLineBreakpoint) breakpoint;
	...
	public void handleMessage(edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage message) {
		try {
			if (message.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.STARTED)) {
				started();
			} else if (message.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.SUSPENDED)) {
				suspend();
			} else if (message.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.TERMINATED)) {
				terminated();
			} else if (message.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.RESUMED)) {
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugProxy getDebugProxy() {
