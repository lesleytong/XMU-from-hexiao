 ...
 * conversion.
 */
public interface IXmuInputStreamProcessorProvider {
	 ...
	 */
	public edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
