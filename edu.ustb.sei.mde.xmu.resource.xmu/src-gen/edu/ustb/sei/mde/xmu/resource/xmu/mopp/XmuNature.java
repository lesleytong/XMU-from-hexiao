...
public class XmuNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "edu.ustb.sei.mde.xmu.resource.xmu.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
