...
public class XmuRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
