 ...
 */
public class XmuEnumerationTerminal extends edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public XmuEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuCardinality cardinality, int mandatoryOccurrencesAfter) {
