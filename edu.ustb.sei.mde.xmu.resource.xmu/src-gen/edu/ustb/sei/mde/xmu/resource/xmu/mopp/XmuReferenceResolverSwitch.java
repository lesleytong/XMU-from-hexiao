...
public class XmuReferenceResolverSwitch implements edu.ustb.sei.mde.xmu.resource.xmu.IXmuReferenceResolverSwitch {
	...
	protected edu.ustb.sei.mde.xmu.resource.xmu.analysis.ResetStatementVariablesReferenceResolver resetStatementVariablesReferenceResolver = new edu.ustb.sei.mde.xmu.resource.xmu.analysis.ResetStatementVariablesReferenceResolver();
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.IXmuReferenceResolver<edu.ustb.sei.mde.xmu.ResetStatement, edu.ustb.sei.mde.xmu.Variable> getResetStatementVariablesReferenceResolver() {
		return getResolverChain(edu.ustb.sei.mde.xmu.XmuPackage.eINSTANCE.getResetStatement_Variables(), resetStatementVariablesReferenceResolver);
	}
	...
	public void setOptions(java.util.Map<?, ?> options) {
		...
		resetStatementVariablesReferenceResolver.setOptions(options);
	}
	...
	public void resolveFuzzy(String identifier, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, int position, edu.ustb.sei.mde.xmu.resource.xmu.IXmuReferenceResolveResult<org.eclipse.emf.ecore.EObject> result) {
		...
		if (edu.ustb.sei.mde.xmu.XmuPackage.eINSTANCE.getResetStatement().isInstance(container)) {
			XmuFuzzyResolveResult<edu.ustb.sei.mde.xmu.Variable> frr = new XmuFuzzyResolveResult<edu.ustb.sei.mde.xmu.Variable>(result);
			String referenceName = reference.getName();
			org.eclipse.emf.ecore.EStructuralFeature feature = container.eClass().getEStructuralFeature(referenceName);
			if (feature != null && feature instanceof org.eclipse.emf.ecore.EReference && referenceName != null && referenceName.equals("variables")) {
				resetStatementVariablesReferenceResolver.resolve(identifier, (edu.ustb.sei.mde.xmu.ResetStatement) container, (org.eclipse.emf.ecore.EReference) feature, position, true, frr);
			}
		}
	}
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.IXmuReferenceResolver<? extends org.eclipse.emf.ecore.EObject, ? extends org.eclipse.emf.ecore.EObject> getResolver(org.eclipse.emf.ecore.EStructuralFeature reference) {
		...
		if (reference == edu.ustb.sei.mde.xmu.XmuPackage.eINSTANCE.getResetStatement_Variables()) {
			return getResolverChain(reference, resetStatementVariablesReferenceResolver);
		}
		return null;
	}
