...
public class XmuStackFrame extends edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugTarget target;
	private String name;
	private int id;
	...
	public XmuStackFrame(edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = edu.ustb.sei.mde.xmu.resource.xmu.util.XmuStringUtil.decode(data, ',');
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuStackFrame other = (edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuStackFrame) obj;
		if (name == null) {
