...
public class XmuBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "edu.ustb.sei.mde.xmu.resource.xmu.builder";
	
	private edu.ustb.sei.mde.xmu.resource.xmu.IXmuBuilder defaultBuilder = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		edu.ustb.sei.mde.xmu.resource.xmu.IXmuBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource customResource = (edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource) resourceSet.getResource(uri, true);
			new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public edu.ustb.sei.mde.xmu.resource.xmu.IXmuBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMarkerHelper().getMarkerID(edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTaskItemBuilder taskItemBuilder = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTaskItemBuilder();
		new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName())) {
