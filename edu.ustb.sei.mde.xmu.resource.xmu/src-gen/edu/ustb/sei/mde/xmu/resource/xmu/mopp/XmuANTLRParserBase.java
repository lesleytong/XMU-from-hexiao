...
public abstract class XmuANTLRParserBase extends org.antlr.runtime3_4_0.Parser implements edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextParser {
	 ...
	 * result object.
	 */
	protected java.util.Collection<edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource>> postParseCommands;
	 ...
	 */
	private edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTokenResolveResult tokenResolveResult = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTokenResolveResult();
	...
	public XmuANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input) {
		super(input);
	}
	
	public XmuANTLRParserBase(org.antlr.runtime3_4_0.TokenStream input, org.antlr.runtime3_4_0.RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(org.eclipse.emf.ecore.EObject element, edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuPlaceholder;
		isElementToStore |= syntaxElement instanceof edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuKeyword;
		isElementToStore |= syntaxElement instanceof edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformationAdapter layoutInformationAdapter = getLayoutInformationAdapter(element);
		...
		layoutInformationAdapter.addLayoutInformation(new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected String formatTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = edu.ustb.sei.mde.xmu.resource.xmu.util.XmuStringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
	...
	public void setOptions(java.util.Map<?,?> options) {
		...
		if (this.options.containsKey(edu.ustb.sei.mde.xmu.resource.xmu.IXmuOptions.DISABLE_LOCATION_MAP)) {
			this.disableLocationMap = true;
		}
		if (this.options.containsKey(edu.ustb.sei.mde.xmu.resource.xmu.IXmuOptions.DISABLE_LAYOUT_INFORMATION_RECORDING)) {
	...
	protected void addMapEntry(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof org.eclipse.emf.common.util.EMap<?, ?>) {
			org.eclipse.emf.common.util.EMap<Object, Object> valueMap = edu.ustb.sei.mde.xmu.resource.xmu.util.XmuMapUtil.castToEMap(value);
	...
	protected org.eclipse.emf.ecore.EObject apply(org.eclipse.emf.ecore.EObject target, java.util.List<org.eclipse.emf.ecore.EObject> dummyEObjects) {
		...
		for (org.eclipse.emf.ecore.EObject object : dummyEObjects) {
			assert(object instanceof edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuDummyEObject);
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuDummyEObject dummy = (edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuDummyEObject) object;
	...
	protected edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuReferenceResolverSwitch getReferenceResolverSwitch() {
		edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuReferenceResolverSwitch resolverSwitch = (edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
