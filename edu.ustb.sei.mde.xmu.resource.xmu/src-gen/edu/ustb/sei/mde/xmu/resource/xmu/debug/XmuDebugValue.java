...
public class XmuDebugValue extends edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public XmuDebugValue(edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
