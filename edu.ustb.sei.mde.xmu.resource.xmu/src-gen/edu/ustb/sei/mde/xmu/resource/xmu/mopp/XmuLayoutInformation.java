...
/**
 * XmuLayoutInformation objects are used to store layout information that is found
 ...
 * XmuLayoutInformations are aggregated in LayoutInformationAdapters. One
 * XmuLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class XmuLayoutInformation {
	 ...
	 */
	private final edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuSyntaxElement syntaxElement;
	...
	public XmuLayoutInformation(edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.grammar.XmuSyntaxElement getSyntaxElement() {
