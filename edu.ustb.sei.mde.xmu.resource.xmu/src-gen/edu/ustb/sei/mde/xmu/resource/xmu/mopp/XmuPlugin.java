 ...
 */
public class XmuPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "edu.ustb.sei.mde.xmu.resource.xmu";
	/**
	...
	private static XmuPlugin plugin;
	...
	public static XmuPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, XmuPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, XmuPlugin.PLUGIN_ID, message);
		}
		final XmuPlugin pluginInstance = XmuPlugin.getDefault();
