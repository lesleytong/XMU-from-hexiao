 ...
 * code).
 */
public class XmuDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.debug.AbstractXmuDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, edu.ustb.sei.mde.xmu.resource.xmu.util.XmuPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, edu.ustb.sei.mde.xmu.resource.xmu.util.XmuPair<String, Object>>();
	...
	public XmuDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = edu.ustb.sei.mde.xmu.resource.xmu.util.XmuStringUtil.encode('#', stack);
				edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage message = new edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage message = new edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.GET_VARIABLES)) {
				...
				edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage message = new edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugMessage(edu.ustb.sei.mde.xmu.resource.xmu.debug.EXmuDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return edu.ustb.sei.mde.xmu.resource.xmu.util.XmuStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		edu.ustb.sei.mde.xmu.resource.xmu.util.XmuPair<String, Object> pair = new edu.ustb.sei.mde.xmu.resource.xmu.util.XmuPair<String, Object>(name, value);
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.debug.AbstractXmuDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(edu.ustb.sei.mde.xmu.resource.xmu.debug.AbstractXmuDebuggable debuggable) {
