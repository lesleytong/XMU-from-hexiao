 ...
 * to 4 bytes).
 */
public class XmuUnicodeConverter extends edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuInputStreamProcessor {
	 ...
	 */
	public XmuUnicodeConverter(java.io.InputStream inputStream) {
