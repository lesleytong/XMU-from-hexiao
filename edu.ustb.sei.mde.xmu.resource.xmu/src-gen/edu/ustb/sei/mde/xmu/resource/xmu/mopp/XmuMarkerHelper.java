 ...
 * contains <code>edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class XmuMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object>> commands = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object>> commandsToProcess = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextDiagnostic diagnostic) {
		final edu.ustb.sei.mde.xmu.resource.xmu.IXmuProblem problem = diagnostic.getProblem();
		edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemSeverity.ERROR) {
					...
					edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextDiagnostic textDiagnostic = (edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<edu.ustb.sei.mde.xmu.resource.xmu.IXmuQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, edu.ustb.sei.mde.xmu.resource.xmu.util.XmuStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType nextType : edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(edu.ustb.sei.mde.xmu.resource.xmu.XmuEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new edu.ustb.sei.mde.xmu.resource.xmu.util.XmuRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new edu.ustb.sei.mde.xmu.resource.xmu.IXmuCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
