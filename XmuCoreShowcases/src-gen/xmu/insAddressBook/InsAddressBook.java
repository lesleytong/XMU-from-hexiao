...
public class InsAddressBook extends XmuProgram {
  ...
  public void saveSabModel(final URI uri, final TypedGraph data) throws NothingReturnedException, BidirectionalTransformationDefinitionException {
	    edu.ustb.sei.mde.bxcore.util.EcoreModelUtil.save(uri, data, null, getPackage("sab"));
  }
  ...
  public class UnidirectionalAction3 implements BiFunction<SourceType, ViewType, SourceType> {
    public SourceType apply(final SourceType source, final ViewType view) {
      SourceType _xblockexpression = null;
      {
        ...
        java.util.List<edu.ustb.sei.mde.graph.typedGraph.TypedEdge> _navExp = edu.ustb.sei.mde.bxcore.dsl.structure.ExceptionSafeInferface.navigate(source, _contextValue_2, "persons", true, true, false);
