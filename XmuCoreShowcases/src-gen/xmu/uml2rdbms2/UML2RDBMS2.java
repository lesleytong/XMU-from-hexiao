...
public class UML2RDBMS2 extends XmuProgram {
  ...
  public ContextType getType_U6() {
    if(type_u6==null) {
    	...
    	edu.ustb.sei.mde.graph.type.IType sc_type = typeGraph.getTypeNode("Class")
    	;
    	type_u6.addField("sc", sc_type, false);
    	edu.ustb.sei.mde.graph.type.IType oc_type = typeGraph.getTypeNode("Class")
    	;
            ...
            new edu.ustb.sei.mde.bxcore.Derive("xmu20", getType_11(), 
              new edu.ustb.sei.mde.bxcore.Align("xmu21", getType_U1(), getType_12(), getPattern_14(), getPattern_15(), new Condition6(), 
                ...
                new edu.ustb.sei.mde.bxcore.ExpandSource("xmu24", getPattern_19(), 
                  new edu.ustb.sei.mde.bxcore.Invocation("xmu25", getType_U6(), getType_12(), new edu.ustb.sei.mde.structure.Tuple2[]{edu.ustb.sei.mde.structure.Tuple2.make("oc","oc"),edu.ustb.sei.mde.structure.Tuple2.make("sc","cc")}, new edu.ustb.sei.mde.structure.Tuple2[]{edu.ustb.sei.mde.structure.Tuple2.make("t","t")},()->{try {
                    					return getXmu_SuperAttributeToColumn();
                    				} catch(Exception e){
                    					e.printStackTrace();
                    					return null;
