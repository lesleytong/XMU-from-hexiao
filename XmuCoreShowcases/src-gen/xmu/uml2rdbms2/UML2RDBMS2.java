...
public class UML2RDBMS2 extends XmuProgram {
  ...
  /**
   * XmuCoreForEachMatchSource(xmu16)
   */
  ...
  public ContextType getType_U8() {
    if(type_u8==null) {
    	...
    	edu.ustb.sei.mde.graph.type.IType cc_type = typeGraph.getTypeNode("Class")
    	;
    	type_u8.addField("cc", cc_type, false);
    	edu.ustb.sei.mde.graph.type.IType prefix_type = typeGraph.getDataTypeNode("EString")
    	;
    	type_u8.addField("prefix", prefix_type, false);
    	edu.ustb.sei.mde.graph.type.IType oc_type = typeGraph.getTypeNode("Class")
    	;
    ...
    public XmuCore getXmu_PackageToSchema() throws BidirectionalTransformationDefinitionException {
      ...
      public XmuCore getXmu_ClassToTable() throws BidirectionalTransformationDefinitionException {
        ...
        public XmuCore getXmu_AttributeToColumn() throws BidirectionalTransformationDefinitionException {
          ...
          xmu_AttributeToColumn = new edu.ustb.sei.mde.bxcore.ParallelComposition("xmu13", getType_U4(), getType_U12(), new edu.ustb.sei.mde.bxcore.XmuCore[] {
          ...
          public XmuCore getXmu_SuperAttributeToColumn() throws BidirectionalTransformationDefinitionException {
            ...
            new edu.ustb.sei.mde.bxcore.Derive("xmu20", getType_11(), 
              new edu.ustb.sei.mde.bxcore.Align("xmu21", getType_U8(), getType_12(), getPattern_14(), getPattern_15(), new Condition6(), 
