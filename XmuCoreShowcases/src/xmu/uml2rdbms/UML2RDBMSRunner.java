...
public class UML2RDBMSRunner {
	...
	public static void main(String[] args) throws Exception {
		...
		/* use your own models */
		final String umlModelPath = basePath+"/XmuCoreShowcases/src/xmu/uml2rdbms/uml.xmi";
		final String rdbmsModelPath = basePath+"/XmuCoreShowcases/src/xmu/uml2rdbms/rdbms.xmi";
		final String updatedUmlModelPath = basePath+"/XmuCoreShowcases/src/xmu/uml2rdbms/uml-updated.xmi";
