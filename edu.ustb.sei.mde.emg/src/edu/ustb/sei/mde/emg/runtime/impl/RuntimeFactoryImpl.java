...
public class RuntimeFactoryImpl extends EFactoryImpl implements RuntimeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case RuntimePackage.CONTEXT: return createContext();
			case RuntimePackage.ENVIRONMENT: return createEnvironment();
			default:
	 ...
	 * @generated
	 */
	public ModelSpace createModelSpaceFromString(EDataType eDataType, String initialValue) {
		return (ModelSpace)super.createFromString(eDataType, initialValue);
	}
