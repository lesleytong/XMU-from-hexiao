...
public class DeleteRelationshipsCommand extends ModelCommand {
	...
	@SuppressWarnings("rawtypes")
	public DeleteRelationshipsCommand(ModelSpace space, EObject source, Collection relationships,
