...
public class MorelStackFrame extends edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugTarget target;
	private String name;
	private int id;
	...
	public MorelStackFrame(edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = edu.ustb.sei.mde.morel.resource.morel.util.MorelStringUtil.decode(data, ',');
	...
	private edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		edu.ustb.sei.mde.morel.resource.morel.debug.MorelStackFrame other = (edu.ustb.sei.mde.morel.resource.morel.debug.MorelStackFrame) obj;
		if (name == null) {
