...
public class MorelRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			edu.ustb.sei.mde.morel.resource.morel.mopp.MorelPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			edu.ustb.sei.mde.morel.resource.morel.mopp.MorelPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
