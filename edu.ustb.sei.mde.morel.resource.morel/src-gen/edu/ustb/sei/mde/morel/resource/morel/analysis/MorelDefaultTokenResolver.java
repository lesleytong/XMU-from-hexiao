 ...
 */
public class MorelDefaultTokenResolver implements edu.ustb.sei.mde.morel.resource.morel.IMorelTokenResolver {
	 ...
	 */
	public MorelDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public MorelDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, edu.ustb.sei.mde.morel.resource.morel.IMorelTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : edu.ustb.sei.mde.morel.resource.morel.grammar.MorelGrammarInformationProvider.INSTANCE.getKeywords()) {
