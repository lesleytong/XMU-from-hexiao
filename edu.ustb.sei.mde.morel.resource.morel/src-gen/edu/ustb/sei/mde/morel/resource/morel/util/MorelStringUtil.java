...
public class MorelStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, edu.ustb.sei.mde.morel.resource.morel.IMorelFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, edu.ustb.sei.mde.morel.resource.morel.IMorelFunction1<String, T> toStringFunction) {
