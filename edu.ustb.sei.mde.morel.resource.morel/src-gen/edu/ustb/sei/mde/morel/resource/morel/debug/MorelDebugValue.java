...
public class MorelDebugValue extends edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public MorelDebugValue(edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
