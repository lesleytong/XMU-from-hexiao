...
/**
 * MorelLayoutInformation objects are used to store layout information that is
 ...
 * MorelLayoutInformations are aggregated in LayoutInformationAdapters. One
 * MorelLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class MorelLayoutInformation {
	 ...
	 */
	private final edu.ustb.sei.mde.morel.resource.morel.grammar.MorelSyntaxElement syntaxElement;
	...
	public MorelLayoutInformation(edu.ustb.sei.mde.morel.resource.morel.grammar.MorelSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public edu.ustb.sei.mde.morel.resource.morel.grammar.MorelSyntaxElement getSyntaxElement() {
