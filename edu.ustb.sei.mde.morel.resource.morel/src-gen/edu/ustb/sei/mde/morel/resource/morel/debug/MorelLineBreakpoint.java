...
public class MorelLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "edu.ustb.sei.mde.morel.resource.morel.debug.lineBreakpoint.marker";
	
	public MorelLineBreakpoint() {
		super();
	}
	
	public MorelLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugTarget target) {
		try {
	...
	public void remove(edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
