 ...
 */
public class MorelResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new edu.ustb.sei.mde.morel.resource.morel.util.MorelInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new edu.ustb.sei.mde.morel.resource.morel.util.MorelInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static edu.ustb.sei.mde.morel.resource.morel.mopp.MorelResource getResource(java.io.File file) {
	...
	public static edu.ustb.sei.mde.morel.resource.morel.mopp.MorelResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (edu.ustb.sei.mde.morel.resource.morel.mopp.MorelResource) resource;
	}
	 ...
	 */
	public static edu.ustb.sei.mde.morel.QueryModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static edu.ustb.sei.mde.morel.QueryModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (edu.ustb.sei.mde.morel.QueryModel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static edu.ustb.sei.mde.morel.QueryModel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource resource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		edu.ustb.sei.mde.morel.resource.morel.IMorelTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
