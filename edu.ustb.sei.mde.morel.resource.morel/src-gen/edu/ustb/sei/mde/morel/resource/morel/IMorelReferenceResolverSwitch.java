...
/**
 * A IMorelReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IMorelReferenceResolverSwitch extends edu.ustb.sei.mde.morel.resource.morel.IMorelConfigurable {
