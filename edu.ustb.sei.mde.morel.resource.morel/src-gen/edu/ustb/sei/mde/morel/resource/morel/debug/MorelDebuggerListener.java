 ...
 * code).
 */
public class MorelDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private edu.ustb.sei.mde.morel.resource.morel.debug.AbstractMorelDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, edu.ustb.sei.mde.morel.resource.morel.util.MorelPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, edu.ustb.sei.mde.morel.resource.morel.util.MorelPair<String, Object>>();
	...
	public MorelDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = edu.ustb.sei.mde.morel.resource.morel.util.MorelStringUtil.encode('#', stack);
				edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage message = new edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage message = new edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.GET_VARIABLES)) {
				...
				edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage message = new edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugMessage(edu.ustb.sei.mde.morel.resource.morel.debug.EMorelDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return edu.ustb.sei.mde.morel.resource.morel.util.MorelStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		edu.ustb.sei.mde.morel.resource.morel.util.MorelPair<String, Object> pair = new edu.ustb.sei.mde.morel.resource.morel.util.MorelPair<String, Object>(name, value);
	...
	public edu.ustb.sei.mde.morel.resource.morel.debug.AbstractMorelDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(edu.ustb.sei.mde.morel.resource.morel.debug.AbstractMorelDebuggable debuggable) {
