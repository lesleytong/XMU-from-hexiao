...
/**
 * A MorelLayoutInformationAdapter is used to store layout information that is
 ...
 * MorelLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class MorelLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation> layoutInformations = new java.util.ArrayList<edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation>();
	...
	public java.util.List<edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation layoutInformation) {
