 ...
 */
public class MorelPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "edu.ustb.sei.mde.morel.resource.morel";
	/**
	...
	private static MorelPlugin plugin;
	...
	public static MorelPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, MorelPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, MorelPlugin.PLUGIN_ID, message);
		}
		final MorelPlugin pluginInstance = MorelPlugin.getDefault();
