...
public class MorelLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		edu.ustb.sei.mde.morel.resource.morel.grammar.MorelSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), edu.ustb.sei.mde.morel.resource.morel.grammar.MorelGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		edu.ustb.sei.mde.morel.resource.morel.grammar.MorelSyntaxElement syntaxElement = edu.ustb.sei.mde.morel.resource.morel.grammar.MorelGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof edu.ustb.sei.mde.morel.resource.morel.grammar.MorelPlaceholder) {
			edu.ustb.sei.mde.morel.resource.morel.grammar.MorelPlaceholder placeholder = (edu.ustb.sei.mde.morel.resource.morel.grammar.MorelPlaceholder) syntaxElement;
			edu.ustb.sei.mde.morel.resource.morel.IMorelTokenResolver tokenResolver = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			edu.ustb.sei.mde.morel.resource.morel.IMorelTokenResolveResult result = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public edu.ustb.sei.mde.morel.resource.morel.mopp.MorelLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
