 ...
 */
public interface IMorelOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().getResourcePostProcessorProviderOptionKey();
