 ...
 * to 4 bytes).
 */
public class MorelUnicodeConverter extends edu.ustb.sei.mde.morel.resource.morel.mopp.MorelInputStreamProcessor {
	 ...
	 */
	public MorelUnicodeConverter(java.io.InputStream inputStream) {
