...
public class MorelDefaultResolverDelegate<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	...
	private static edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation metaInformation = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation();
	
	private edu.ustb.sei.mde.morel.resource.morel.IMorelNameProvider nameProvider = metaInformation.createNameProvider();
	 ...
	 */
	protected void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, edu.ustb.sei.mde.morel.resource.morel.IMorelReferenceResolveResult<ReferenceType> result) {
		try {
	...
	protected boolean tryToResolveIdentifierAsURI(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, edu.ustb.sei.mde.morel.resource.morel.IMorelReferenceResolveResult<ReferenceType> result) {
		org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
	...
	protected boolean tryToResolveIdentifierInGenModelRegistry(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, edu.ustb.sei.mde.morel.resource.morel.IMorelReferenceResolveResult<ReferenceType> result) {
		org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
	...
	protected boolean checkElement(org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EReference reference, int position, org.eclipse.emf.ecore.EClass type, String identifier, boolean resolveFuzzy, boolean checkStringWise, edu.ustb.sei.mde.morel.resource.morel.IMorelReferenceResolveResult<ReferenceType> result) {
		...
		if (exactMatch == null) {
			...
			if (similarMatch != null) {
				...
				result.addQuickFix(new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelChangeReferenceQuickFix("Replace with " + similarMatch, "IMG_TOOL_FORWARD", container, reference, oldTarget, element));
			}
			return true;
		}
	...
	protected String produceDeResolveErrorMessage(org.eclipse.emf.ecore.EObject refObject, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource resource) {
	...
	protected edu.ustb.sei.mde.morel.resource.morel.IMorelReferenceCache getCache(org.eclipse.emf.ecore.EObject object) {
		org.eclipse.emf.ecore.EObject root = org.eclipse.emf.ecore.util.EcoreUtil.getRootContainer(object);
		org.eclipse.emf.common.notify.Adapter adapter = edu.ustb.sei.mde.morel.resource.morel.util.MorelEObjectUtil.getEAdapter(root, edu.ustb.sei.mde.morel.resource.morel.analysis.MorelReferenceCache.class);
		edu.ustb.sei.mde.morel.resource.morel.analysis.MorelReferenceCache cache = edu.ustb.sei.mde.morel.resource.morel.util.MorelCastUtil.cast(adapter);
		if (cache != null) {
			return cache;
		} else {
			// cache does not exist. create a new one.
			cache = new edu.ustb.sei.mde.morel.resource.morel.analysis.MorelReferenceCache(nameProvider);
	...
	protected boolean isSimilar(String identifier, Object attributeValue) {
		if (attributeValue != null && attributeValue instanceof String) {
			String name = (String) attributeValue;
			if (edu.ustb.sei.mde.morel.resource.morel.util.MorelStringUtil.computeLevenshteinDistance(identifier, name) <= MAX_DISTANCE) {
				return true;
			}
		}
		return false;
