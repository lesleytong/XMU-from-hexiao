 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.morel.impl.StringLiteralExpImpl#getStringSymbol <em>String Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralExpImpl extends LiteralExpImpl implements StringLiteralExp {
	...
	protected EClass eStaticClass() {
		return MorelPackage.Literals.STRING_LITERAL_EXP;
	}
	...
	public void setStringSymbol(String newStringSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MorelPackage.STRING_LITERAL_EXP__STRING_SYMBOL, oldStringSymbol, stringSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MorelPackage.STRING_LITERAL_EXP__STRING_SYMBOL:
