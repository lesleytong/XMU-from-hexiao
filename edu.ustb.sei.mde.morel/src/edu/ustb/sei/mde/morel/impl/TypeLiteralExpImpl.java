 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.morel.impl.TypeLiteralExpImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeLiteralExpImpl extends LiteralExpImpl implements TypeLiteralExp {
	...
	protected EClass eStaticClass() {
		return MorelPackage.Literals.TYPE_LITERAL_EXP;
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MorelPackage.TYPE_LITERAL_EXP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(EClassifier newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MorelPackage.TYPE_LITERAL_EXP__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MorelPackage.TYPE_LITERAL_EXP__VALUE:
