...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Object Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.morel.impl.ActionObjectVariableImpl#getActionType <em>Action Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ActionObjectVariableImpl extends ObjectVariableImpl implements ActionObjectVariable {
	/**
	 ...
	 * @generated
	 */
	protected ActionObjectVariableImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MorelPackage.Literals.ACTION_OBJECT_VARIABLE;
	}
	...
	public void setActionType(ActionElementType newActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MorelPackage.ACTION_OBJECT_VARIABLE__ACTION_TYPE, oldActionType, actionType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MorelPackage.ACTION_OBJECT_VARIABLE__ACTION_TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ActionElement.class) {
			switch (derivedFeatureID) {
				case MorelPackage.ACTION_OBJECT_VARIABLE__ACTION_TYPE: return MorelPackage.ACTION_ELEMENT__ACTION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ActionElement.class) {
			switch (baseFeatureID) {
				case MorelPackage.ACTION_ELEMENT__ACTION_TYPE: return MorelPackage.ACTION_OBJECT_VARIABLE__ACTION_TYPE;
				default: return -1;
			}
		}
