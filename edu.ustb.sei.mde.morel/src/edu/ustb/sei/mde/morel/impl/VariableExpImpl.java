 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.morel.impl.VariableExpImpl#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VariableExpImpl extends AtomicExpImpl implements VariableExp {
	/**
	...
	protected EClass eStaticClass() {
		return MorelPackage.Literals.VARIABLE_EXP;
	}
		...
		if (referredVariable != null && referredVariable.eIsProxy()) {
			...
			if (referredVariable != oldReferredVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MorelPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
			}
		}
	...
	public void setReferredVariable(Variable newReferredVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MorelPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MorelPackage.VARIABLE_EXP__REFERRED_VARIABLE:
