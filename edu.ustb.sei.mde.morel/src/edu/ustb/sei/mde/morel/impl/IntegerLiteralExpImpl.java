 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.morel.impl.IntegerLiteralExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralExpImpl extends LiteralExpImpl implements IntegerLiteralExp {
	...
	protected EClass eStaticClass() {
		return MorelPackage.Literals.INTEGER_LITERAL_EXP;
	}
	...
	public void setIntegerSymbol(int newIntegerSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MorelPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MorelPackage.INTEGER_LITERAL_EXP__INTEGER_SYMBOL:
