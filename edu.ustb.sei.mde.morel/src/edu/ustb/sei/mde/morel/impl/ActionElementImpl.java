 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.morel.impl.ActionElementImpl#getActionType <em>Action Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ActionElementImpl extends MinimalEObjectImpl.Container implements ActionElement {
	/**
	...
	protected EClass eStaticClass() {
		return MorelPackage.Literals.ACTION_ELEMENT;
	}
	...
	public void setActionType(ActionElementType newActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MorelPackage.ACTION_ELEMENT__ACTION_TYPE, oldActionType, actionType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MorelPackage.ACTION_ELEMENT__ACTION_TYPE:
