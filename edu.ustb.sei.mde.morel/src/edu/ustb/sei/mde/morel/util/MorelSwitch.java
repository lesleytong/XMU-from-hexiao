...
public class MorelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MorelPackage.BX_MOREL_MODEL: {
				BxMorelModel bxMorelModel = (BxMorelModel)theEObject;
				T result = caseBxMorelModel(bxMorelModel);
				if (result == null) result = caseUnit(bxMorelModel);
				if (result == null) result = caseNamedElement(bxMorelModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.BX_MOREL_RULE: {
				BxMorelRule bxMorelRule = (BxMorelRule)theEObject;
				T result = caseBxMorelRule(bxMorelRule);
				if (result == null) result = caseRuleElement(bxMorelRule);
				if (result == null) result = caseNamedElement(bxMorelRule);
				if (result == null) result = caseExecutable(bxMorelRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = casePattern(action);
				if (result == null) result = caseSection(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.CASE_STATEMENT: {
				CaseStatement caseStatement = (CaseStatement)theEObject;
				T result = caseCaseStatement(caseStatement);
				if (result == null) result = caseImperativeStatement(caseStatement);
				if (result == null) result = caseStatement(caseStatement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.CASE_BLOCK: {
				CaseBlock caseBlock = (CaseBlock)theEObject;
				T result = caseCaseBlock(caseBlock);
				if (result == null) result = caseImperativeExp(caseBlock);
				if (result == null) result = caseExpression(caseBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.ACTION_ELEMENT: {
				ActionElement actionElement = (ActionElement)theEObject;
				T result = caseActionElement(actionElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.ACTION_OBJECT_VARIABLE: {
				ActionObjectVariable actionObjectVariable = (ActionObjectVariable)theEObject;
				T result = caseActionObjectVariable(actionObjectVariable);
				if (result == null) result = caseObjectVariable(actionObjectVariable);
				if (result == null) result = caseActionElement(actionObjectVariable);
				if (result == null) result = caseVariable(actionObjectVariable);
				if (result == null) result = caseNamedElement(actionObjectVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.ACTION_SIMPLE_LINK_CONSTRAINT: {
				ActionSimpleLinkConstraint actionSimpleLinkConstraint = (ActionSimpleLinkConstraint)theEObject;
				T result = caseActionSimpleLinkConstraint(actionSimpleLinkConstraint);
				if (result == null) result = caseSimpleLinkConstraint(actionSimpleLinkConstraint);
				if (result == null) result = caseActionElement(actionSimpleLinkConstraint);
				if (result == null) result = caseLinkConstraint(actionSimpleLinkConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MorelPackage.BX_TYPED_MODEL: {
				BxTypedModel bxTypedModel = (BxTypedModel)theEObject;
				T result = caseBxTypedModel(bxTypedModel);
				if (result == null) result = caseTypedModel(bxTypedModel);
				if (result == null) result = caseNamedElement(bxTypedModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bx Morel Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bx Morel Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBxMorelModel(BxMorelModel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bx Morel Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bx Morel Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBxMorelRule(BxMorelRule object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Action Object Variable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Action Object Variable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActionObjectVariable(ActionObjectVariable object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Action Simple Link Constraint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Action Simple Link Constraint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActionSimpleLinkConstraint(ActionSimpleLinkConstraint object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bx Typed Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bx Typed Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBxTypedModel(BxTypedModel object) {
		return null;
	}
