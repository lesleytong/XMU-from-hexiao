 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu2.statement.impl.BlockStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockStatementImpl extends StatementImpl implements BlockStatement {
	...
	public EList<Statement> getBody() {
		if (body == null) {
			body = new EObjectContainmentEList<Statement>(Statement.class, this, StatementPackage.BLOCK_STATEMENT__BODY);
		}
		return body;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StatementPackage.BLOCK_STATEMENT__BODY:
