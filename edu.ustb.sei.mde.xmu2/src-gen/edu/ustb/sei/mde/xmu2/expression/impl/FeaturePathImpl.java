 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu2.expression.impl.FeaturePathImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeaturePathImpl extends PathImpl implements FeaturePath {
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.FEATURE_PATH;
	}
	...
	public void setFeature(String newFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.FEATURE_PATH__FEATURE, oldFeature, feature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionPackage.FEATURE_PATH__FEATURE:
				return getFeature();
		}
