...
public class CommandStatementImpl extends StatementImpl implements CommandStatement {
	...
	protected EClass eStaticClass() {
		return Xmu2corePackage.Literals.COMMAND_STATEMENT;
	}
	...
	public void setCommand(String newCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xmu2corePackage.COMMAND_STATEMENT__COMMAND, oldCommand, command));
	}
