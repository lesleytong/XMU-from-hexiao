 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu2core.impl.BooleanOrExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanOrExpressionImpl extends ExpressionImpl implements BooleanOrExpression {
	...
	protected EClass eStaticClass() {
		return Xmu2corePackage.Literals.BOOLEAN_OR_EXPRESSION;
	}
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, Xmu2corePackage.BOOLEAN_OR_EXPRESSION__OPERANDS);
		}
		return operands;
	}
