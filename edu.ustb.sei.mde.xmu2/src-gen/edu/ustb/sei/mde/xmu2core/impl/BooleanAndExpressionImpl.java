 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu2core.impl.BooleanAndExpressionImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanAndExpressionImpl extends ExpressionImpl implements BooleanAndExpression {
	...
	protected EClass eStaticClass() {
		return Xmu2corePackage.Literals.BOOLEAN_AND_EXPRESSION;
	}
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, Xmu2corePackage.BOOLEAN_AND_EXPRESSION__OPERANDS);
		}
		return operands;
	}
