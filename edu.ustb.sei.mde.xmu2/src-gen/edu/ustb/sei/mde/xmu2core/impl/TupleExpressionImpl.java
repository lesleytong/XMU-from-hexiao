 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu2core.impl.TupleExpressionImpl#getTuples <em>Tuples</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpressionImpl extends ExpressionImpl implements TupleExpression {
	 ...
	 * @ordered
	 */
	protected EList<Expression> tuples;
	...
	protected EClass eStaticClass() {
		return Xmu2corePackage.Literals.TUPLE_EXPRESSION;
	}
	 ...
	 * @generated
	 */
	public EList<Expression> getTuples() {
		if (tuples == null) {
			tuples = new EObjectContainmentEList<Expression>(Expression.class, this, Xmu2corePackage.TUPLE_EXPRESSION__TUPLES);
		}
		return tuples;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Xmu2corePackage.TUPLE_EXPRESSION__TUPLES:
				getTuples().clear();
				getTuples().addAll((Collection<? extends Expression>)newValue);
				return;
		}
