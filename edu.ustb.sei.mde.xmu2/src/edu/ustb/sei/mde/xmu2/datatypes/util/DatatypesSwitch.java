...
public class DatatypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatatypesPackage.OCL_COLLECTION: {
				OclCollection oclCollection = (OclCollection)theEObject;
				T result = caseOclCollection(oclCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.FEATURE_COLLECTION: {
				FeatureCollection featureCollection = (FeatureCollection)theEObject;
				T result = caseFeatureCollection(featureCollection);
				if (result == null) result = caseOclCollection(featureCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatatypesPackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = caseOclCollection(resource);
				if (result == null) result = caseDomainElement(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
