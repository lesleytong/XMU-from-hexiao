...
public class BXCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BXCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModificationExpressionAccess().getGroup_0_3_2(), "rule__ModificationExpression__Group_0_3_2__0");
			builder.put(grammarAccess.getModificationExpressionAccess().getGroup_1(), "rule__ModificationExpression__Group_1__0");
			...
			builder.put(grammarAccess.getXbaseXReturnExpressionAccess().getGroup(), "superXReturnExpression__Group__0");
			...
			builder.put(grammarAccess.getModificationExpressionAccess().getValueMappingsAssignment_0_3_2_1(), "rule__ModificationExpression__ValueMappingsAssignment_0_3_2_1");
			builder.put(grammarAccess.getModificationExpressionAccess().getElementAssignment_1_2(), "rule__ModificationExpression__ElementAssignment_1_2");
			...
			builder.put(grammarAccess.getXbaseXReturnExpressionAccess().getExpressionAssignment_2(), "superXReturnExpression__ExpressionAssignment_2");
