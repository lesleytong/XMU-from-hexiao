...
public class BXCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BXCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPatternTypeLiteralAccess().getGroup_4_2(), "rule__PatternTypeLiteral__Group_4_2__0");
			...
			builder.put(grammarAccess.getXmuCoreForkAccess().getGroup_3(), "rule__XmuCoreFork__Group_3__0");
			...
			builder.put(grammarAccess.getTypeVarAccess().getManyAssignment_3(), "rule__TypeVar__ManyAssignment_3");
			...
			builder.put(grammarAccess.getPatternTypeLiteralAccess().getFilterAssignment_3_1(), "rule__PatternTypeLiteral__FilterAssignment_3_1");
			builder.put(grammarAccess.getPatternTypeLiteralAccess().getAdditionalAssignment_4_1(), "rule__PatternTypeLiteral__AdditionalAssignment_4_1");
			builder.put(grammarAccess.getPatternTypeLiteralAccess().getAdditionalAssignment_4_2_1(), "rule__PatternTypeLiteral__AdditionalAssignment_4_2_1");
			...
			builder.put(grammarAccess.getXmuCoreContextSourceAccess().getMappingSourceAssignment_2(), "rule__XmuCoreContextSource__MappingSourceAssignment_2");
			builder.put(grammarAccess.getXmuCoreContextSourceAccess().getMappingViewAssignment_4(), "rule__XmuCoreContextSource__MappingViewAssignment_4");
			builder.put(grammarAccess.getXmuCoreContextSourceAccess().getBodyAssignment_5(), "rule__XmuCoreContextSource__BodyAssignment_5");
			...
			builder.put(grammarAccess.getXmuCoreDeriveSourceAccess().getDerivationFunctionsAssignment_3(), "rule__XmuCoreDeriveSource__DerivationFunctionsAssignment_3");
			builder.put(grammarAccess.getXmuCoreDeriveSourceAccess().getDerivedTypeAssignment_6(), "rule__XmuCoreDeriveSource__DerivedTypeAssignment_6");
			builder.put(grammarAccess.getXmuCoreDeriveSourceAccess().getBodyAssignment_7(), "rule__XmuCoreDeriveSource__BodyAssignment_7");
			...
			builder.put(grammarAccess.getXmuCoreDependencyViewAccess().getDependencyFunctionsAssignment_3(), "rule__XmuCoreDependencyView__DependencyFunctionsAssignment_3");
			builder.put(grammarAccess.getXmuCoreDependencyViewAccess().getDependentTypeAssignment_6(), "rule__XmuCoreDependencyView__DependentTypeAssignment_6");
			builder.put(grammarAccess.getXmuCoreDependencyViewAccess().getBodyAssignment_7(), "rule__XmuCoreDependencyView__BodyAssignment_7");
			...
			builder.put(grammarAccess.getVarMappingAccess().getFromAssignment_0(), "rule__VarMapping__FromAssignment_0");
			builder.put(grammarAccess.getVarMappingAccess().getToAssignment_2(), "rule__VarMapping__ToAssignment_2");
			...
			builder.put(grammarAccess.getModificationExpressionBlockAccess().getExpressionsAssignment_2(), "rule__ModificationExpressionBlock__ExpressionsAssignment_2");
