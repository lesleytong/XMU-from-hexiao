...
public class BXCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BXCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOrderedTupleTypeLiteralAccess().getGroup_1(), "rule__OrderedTupleTypeLiteral__Group_1__0");
			...
			builder.put(grammarAccess.getXmuCoreFunctionCallAccess().getGroup_4(), "rule__XmuCoreFunctionCall__Group_4__0");
			builder.put(grammarAccess.getXmuCoreFunctionCallAccess().getGroup_8(), "rule__XmuCoreFunctionCall__Group_8__0");
			...
			builder.put(grammarAccess.getOrderedTupleTypeLiteralAccess().getElementsAssignment_1_1(), "rule__OrderedTupleTypeLiteral__ElementsAssignment_1_1");
			builder.put(grammarAccess.getOrderedTupleTypeLiteralAccess().getElementsAssignment_1_2_1(), "rule__OrderedTupleTypeLiteral__ElementsAssignment_1_2_1");
			...
			builder.put(grammarAccess.getXmuCoreContextSourceAccess().getMappingViewAssignment_3(), "rule__XmuCoreContextSource__MappingViewAssignment_3");
			builder.put(grammarAccess.getXmuCoreContextSourceAccess().getBodyAssignment_4(), "rule__XmuCoreContextSource__BodyAssignment_4");
			...
			builder.put(grammarAccess.getXmuCoreFunctionCallAccess().getSourceMappingsAssignment_3(), "rule__XmuCoreFunctionCall__SourceMappingsAssignment_3");
			builder.put(grammarAccess.getXmuCoreFunctionCallAccess().getSourceMappingsAssignment_4_1(), "rule__XmuCoreFunctionCall__SourceMappingsAssignment_4_1");
			builder.put(grammarAccess.getXmuCoreFunctionCallAccess().getViewMappingsAssignment_7(), "rule__XmuCoreFunctionCall__ViewMappingsAssignment_7");
			builder.put(grammarAccess.getXmuCoreFunctionCallAccess().getViewMappingsAssignment_8_1(), "rule__XmuCoreFunctionCall__ViewMappingsAssignment_8_1");
