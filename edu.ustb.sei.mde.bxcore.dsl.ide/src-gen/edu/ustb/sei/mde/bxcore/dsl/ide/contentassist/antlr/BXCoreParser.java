...
public class BXCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BXCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getGroup_7(), "rule__NewInstanceExpression__Group_7__0");
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getGroup_8(), "rule__NewInstanceExpression__Group_8__0");
			...
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getSideAssignment_2(), "rule__NewInstanceExpression__SideAssignment_2");
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getMetamodelAssignment_4(), "rule__NewInstanceExpression__MetamodelAssignment_4");
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getTypeAssignment_6(), "rule__NewInstanceExpression__TypeAssignment_6");
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getFeatureAssignment_7_1(), "rule__NewInstanceExpression__FeatureAssignment_7_1");
			builder.put(grammarAccess.getNewInstanceExpressionAccess().getSizeAssignment_8_1(), "rule__NewInstanceExpression__SizeAssignment_8_1");
