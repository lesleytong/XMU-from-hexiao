...
public class BXCoreParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BXCoreGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModificationExpressionOrSuperExpressionAccess().getAlternatives(), "rule__ModificationExpressionOrSuperExpression__Alternatives");
			...
			builder.put(grammarAccess.getPatternEdgeAccess().getOperatorAssignment_3(), "rule__PatternEdge__OperatorAssignment_3");
			builder.put(grammarAccess.getPatternEdgeAccess().getValueAssignment_4(), "rule__PatternEdge__ValueAssignment_4");
