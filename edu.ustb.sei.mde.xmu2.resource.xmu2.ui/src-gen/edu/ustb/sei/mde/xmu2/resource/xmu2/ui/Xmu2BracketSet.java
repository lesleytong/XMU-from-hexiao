...
public class Xmu2BracketSet {
	...
	private java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair {
	 ...
	 */
	private class ClosingListener implements edu.ustb.sei.mde.xmu2.resource.xmu2.ui.IXmu2BracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public Xmu2BracketSet(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair>();
	 ...
	 */
	public edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair getBracketPair(String opening, String closing) {
		for (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair bracketPair : bracketPairs) {
	...
	public edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair remove(String opening, String closing) {
		for (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
