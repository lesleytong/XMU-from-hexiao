 ...
 */
public class Xmu2UIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "edu.ustb.sei.mde.xmu2.resource.xmu2.ui";
	public static final String EDITOR_ID = "edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor";
	...
	private static Xmu2UIPlugin plugin;
	...
	public static Xmu2UIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Xmu2UIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, Xmu2UIPlugin.PLUGIN_ID, message);
		}
		final Xmu2UIPlugin pluginInstance = Xmu2UIPlugin.getDefault();
