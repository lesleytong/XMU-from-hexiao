 ...
 */
public class Xmu2Occurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "edu.ustb.sei.mde.xmu2.resource.xmu2.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "edu.ustb.sei.mde.xmu2.resource.xmu2.ui.occurences.declaration";
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2TokenScanner tokenScanner;
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource textResource;
	 ...
	 */
	public Xmu2Occurrence(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2TokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if (elementsAtDefinition.contains(occEO) || definitionElement.equals(occEO)) {
						addAnnotation(document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Occurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Occurrence.DECLARATION_ANNOTATION_ID);
	}
