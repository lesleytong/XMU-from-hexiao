 ...
 * olInput</code>.
 */
public class Xmu2DocBrowserInformationControlInput {
	
	private final Xmu2DocBrowserInformationControlInput fPrevious;
	private Xmu2DocBrowserInformationControlInput fNext;
	 ...
	 */
	public Xmu2DocBrowserInformationControlInput(Xmu2DocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public Xmu2DocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public Xmu2DocBrowserInformationControlInput getNext() {
		return fNext;
	}
