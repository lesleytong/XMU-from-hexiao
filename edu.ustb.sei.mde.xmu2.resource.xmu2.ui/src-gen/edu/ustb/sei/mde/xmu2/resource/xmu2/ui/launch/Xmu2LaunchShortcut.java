...
public class Xmu2LaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(edu.ustb.sei.mde.xmu2.resource.xmu2.launch.Xmu2LaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
