 ...
 */
public class Xmu2Hyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public Xmu2Hyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
