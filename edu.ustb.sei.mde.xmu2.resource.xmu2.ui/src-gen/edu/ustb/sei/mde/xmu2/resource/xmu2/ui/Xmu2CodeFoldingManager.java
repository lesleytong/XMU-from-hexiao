 ...
 */
public class Xmu2CodeFoldingManager {
	
	private class FoldingUpdateListener implements edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor) {
				edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor = (edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor) workbenchPart;
	...
	protected edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor;
	 ...
	 */
	public Xmu2CodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor textEditor) {
	...
	private void addCloseListener(final edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource textResource = (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
