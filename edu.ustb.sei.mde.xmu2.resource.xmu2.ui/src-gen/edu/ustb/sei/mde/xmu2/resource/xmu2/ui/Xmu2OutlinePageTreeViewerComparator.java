...
public class Xmu2OutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2NameProvider nameProvider = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().createNameProvider();
