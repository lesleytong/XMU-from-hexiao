...
/**
 * A text editor for 'xmu2' models.
 * <p>
 * This editor has id
 * <code>edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor</code>
 * The editor's context menu has id
 * <code>edu.ustb.sei.mde.xmu2.resource.xmu2.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>edu.ustb.sei.mde.xmu2.resource.xmu2.EditorRuler</code>.
 * </p>
 */
public class Xmu2Editor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2ResourceProvider, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.IXmu2BracketHandlerProvider, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.IXmu2AnnotationModelProvider {
	
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Highlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2CodeFoldingManager codeFoldingManager;
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BackgroundParsingStrategy bgParsingStrategy = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BackgroundParsingStrategy();
	private java.util.Collection<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BackgroundParsingListener>();
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2ColorManager colorManager = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2ColorManager();
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2OutlinePage outlinePage;
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PropertySheetPage propertySheetPage;
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.IXmu2BracketHandler bracketHandler;
	...
	public Xmu2Editor() {
		super();
		setSourceViewerConfiguration(new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2SourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), Xmu2Editor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource currentResource = getResource();
				...
				edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("edu.ustb.sei.mde.xmu2.resource.xmu2.EditorContext");
		setRulerContextMenuId("edu.ustb.sei.mde.xmu2.resource.xmu2.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Highlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2CodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Nature.activate(inputFile.getProject());
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource loadedResource = (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource) {
					setResource((edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the Xmu2Editor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2OutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource textResource = (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource) element.eResource();
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextToken token = lexer.getNextToken();
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!Xmu2Editor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public edu.ustb.sei.mde.xmu2.resource.xmu2.ui.IXmu2BracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.IXmu2BracketHandler bracketHandler) {
