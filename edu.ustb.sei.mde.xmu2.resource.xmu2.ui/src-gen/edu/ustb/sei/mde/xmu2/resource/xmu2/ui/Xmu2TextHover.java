 ...
 */
public class Xmu2TextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2HoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput infoInput = (edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Hyperlink hyperlink = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Hyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl iControl = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput) {
							edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput input = (edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl.isAvailable(parent)) {
				edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl iControl = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public Xmu2TextHover(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.insertPageProlog(buffer, 0, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2TextHover.getStyleSheet());
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.addPageEpilog(buffer);
			return new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StreamUtil.getContent(styleSheetURL.openStream());
