 ...
 */
public class Xmu2BackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource resource, final edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource resource, final edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource resource, final edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Resource) {
							edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Resource concreteResource = (edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Resource) resource;
