...
public class Xmu2LineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.DEBUG_MODEL_ID);
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2LineBreakpoint lineBreakpoint = new edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2LineBreakpoint(resource, lineNumber + 1);
