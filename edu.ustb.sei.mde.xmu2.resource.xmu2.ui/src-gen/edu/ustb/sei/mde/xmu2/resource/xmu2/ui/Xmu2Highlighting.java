 ...
 */
public class Xmu2Highlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionHelper positionHelper = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionHelper();
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2TokenScanner scanner;
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Occurrence occurrence;
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2BackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public Xmu2Highlighting(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2ColorManager colorManager, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2TokenScanner(textResource, colorManager);
		occurrence = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Occurrence(textResource, sourceviewer, scanner);
		bracketSet = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2BracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Editor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2PositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2EObjectSelection(selectedEObject, false));
				}
			}
		});
	}
