 ...
 * @since 3.2
 */
public class Xmu2BrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput fInput;
	 ...
	 */
	public Xmu2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Xmu2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Xmu2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput);
		...
		fInput= (edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput) input;
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2HTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2DocBrowserInformationControlInput getInput() {
		return fInput;
	}
