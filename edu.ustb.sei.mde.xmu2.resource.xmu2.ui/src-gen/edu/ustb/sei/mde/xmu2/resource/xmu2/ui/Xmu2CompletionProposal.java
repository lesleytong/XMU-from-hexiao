 ...
 */
public class Xmu2CompletionProposal implements java.lang.Comparable<Xmu2CompletionProposal> {
	 ...
	 */
	private edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2ExpectedTerminal expectedTerminal;
	...
	public Xmu2CompletionProposal(edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public Xmu2CompletionProposal(edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public Xmu2CompletionProposal(edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2ExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof Xmu2CompletionProposal) {
			Xmu2CompletionProposal other = (Xmu2CompletionProposal) object;
	...
	public int compareTo(Xmu2CompletionProposal object) {
		if (object instanceof Xmu2CompletionProposal) {
			Xmu2CompletionProposal other = (Xmu2CompletionProposal) object;
