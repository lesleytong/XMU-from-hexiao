 ...
 * a specified depth.
 */
public class Xmu2OutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public Xmu2OutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2EObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.logError("Exception while refreshing outline view", e);
		}
	}
