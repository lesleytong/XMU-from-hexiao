 ...
 */
public class Xmu2NewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("edu.ustb.sei.mde.xmu2.resource.xmu2.ui");
							...
							String natureID = edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Nature.NATURE_ID;
							...
							for (String builderID : edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Nature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation info = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.getDefault().getBundle();
