 ...
 * hovers, is a proxy.
 */
public class Xmu2HyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public Xmu2HyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2Hyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
