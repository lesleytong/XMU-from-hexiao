...
public class Xmu2NewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2NewFileWizardPage page;
	...
	public void addPages() {
		page = new edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2NewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			edu.ustb.sei.mde.xmu2.resource.xmu2.ui.Xmu2UIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getSyntaxName();
	}
