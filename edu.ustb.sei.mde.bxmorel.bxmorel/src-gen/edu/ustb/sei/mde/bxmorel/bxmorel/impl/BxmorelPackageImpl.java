/**
 */
package edu.ustb.sei.mde.bxmorel.bxmorel.impl;

import edu.ustb.sei.mde.bxmorel.bxmorel.BxmorelFactory;
import edu.ustb.sei.mde.bxmorel.bxmorel.BxmorelPackage;
import edu.ustb.sei.mde.bxmorel.bxmorel.DataType;
import edu.ustb.sei.mde.bxmorel.bxmorel.Entity;
import edu.ustb.sei.mde.bxmorel.bxmorel.EntityModel;
import edu.ustb.sei.mde.bxmorel.bxmorel.Feature;
import edu.ustb.sei.mde.bxmorel.bxmorel.FeatureKind;
import edu.ustb.sei.mde.bxmorel.bxmorel.NamedElement;
import edu.ustb.sei.mde.bxmorel.bxmorel.Type;
 ...
 * @generated
 */
public class BxmorelPackageImpl extends EPackageImpl implements BxmorelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see edu.ustb.sei.mde.bxmorel.bxmorel.BxmorelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BxmorelPackageImpl() {
		super(eNS_URI, BxmorelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BxmorelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BxmorelPackage init() {
		if (isInited) return (BxmorelPackage)EPackage.Registry.INSTANCE.getEPackage(BxmorelPackage.eNS_URI);

		// Obtain or create and register package
		BxmorelPackageImpl theBxmorelPackage = (BxmorelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BxmorelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BxmorelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theBxmorelPackage.createPackageContents();

		// Initialize created meta-data
		theBxmorelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBxmorelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BxmorelPackage.eNS_URI, theBxmorelPackage);
		return theBxmorelPackage;
	}
	 ...
	 * @generated
	 */
	public BxmorelFactory getBxmorelFactory() {
		return (BxmorelFactory)getEFactoryInstance();
	}
