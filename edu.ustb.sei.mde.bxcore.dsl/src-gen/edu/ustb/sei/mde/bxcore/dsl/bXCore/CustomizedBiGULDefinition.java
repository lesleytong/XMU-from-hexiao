...
public interface CustomizedBiGULDefinition extends Definition
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Source Params</em>' containment reference list isn't clear,
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>View Params</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
