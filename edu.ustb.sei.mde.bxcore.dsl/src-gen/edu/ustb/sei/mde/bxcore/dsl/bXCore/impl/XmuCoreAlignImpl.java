 ...
 * </p>
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.bxcore.dsl.bXCore.impl.XmuCoreAlignImpl#getSourceType <em>Source Type</em>}</li>
 *   <li>{@link edu.ustb.sei.mde.bxcore.dsl.bXCore.impl.XmuCoreAlignImpl#getViewType <em>View Type</em>}</li>
...
public class XmuCoreAlignImpl extends XmuCoreCompositionChildStatementImpl implements XmuCoreAlign
{
  ...
  public NotificationChain basicSetSourceType(ContextTypeRef newSourceType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BXCorePackage.XMU_CORE_ALIGN__SOURCE_TYPE, oldSourceType, newSourceType);
  ...
  public void setSourceType(ContextTypeRef newSourceType)
  {
    if (newSourceType != sourceType)
    {
      ...
      if (sourceType != null)
        msgs = ((InternalEObject)sourceType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BXCorePackage.XMU_CORE_ALIGN__SOURCE_TYPE, null, msgs);
      if (newSourceType != null)
        msgs = ((InternalEObject)newSourceType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BXCorePackage.XMU_CORE_ALIGN__SOURCE_TYPE, null, msgs);
      msgs = basicSetSourceType(newSourceType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BXCorePackage.XMU_CORE_ALIGN__SOURCE_TYPE, newSourceType, newSourceType));
  }
  ...
  public NotificationChain basicSetViewType(ContextTypeRef newViewType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BXCorePackage.XMU_CORE_ALIGN__VIEW_TYPE, oldViewType, newViewType);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setViewType(ContextTypeRef newViewType)
  {
    if (newViewType != viewType)
    {
      NotificationChain msgs = null;
      if (viewType != null)
        msgs = ((InternalEObject)viewType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BXCorePackage.XMU_CORE_ALIGN__VIEW_TYPE, null, msgs);
      if (newViewType != null)
        msgs = ((InternalEObject)newViewType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BXCorePackage.XMU_CORE_ALIGN__VIEW_TYPE, null, msgs);
      msgs = basicSetViewType(newViewType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BXCorePackage.XMU_CORE_ALIGN__VIEW_TYPE, newViewType, newViewType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BXCorePackage.XMU_CORE_ALIGN__SOURCE_TYPE:
        return basicSetSourceType(null, msgs);
      case BXCorePackage.XMU_CORE_ALIGN__VIEW_TYPE:
