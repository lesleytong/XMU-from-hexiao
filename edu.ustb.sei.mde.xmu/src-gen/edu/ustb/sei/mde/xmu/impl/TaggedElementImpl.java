 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu.impl.TaggedElementImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TaggedElementImpl extends MinimalEObjectImpl.Container implements TaggedElement {
	...
	protected EClass eStaticClass() {
		return XmuPackage.Literals.TAGGED_ELEMENT;
	}
	...
	public void setTag(VariableFlag newTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmuPackage.TAGGED_ELEMENT__TAG, oldTag, tag));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XmuPackage.TAGGED_ELEMENT__TAG:
				return getTag();
		}
