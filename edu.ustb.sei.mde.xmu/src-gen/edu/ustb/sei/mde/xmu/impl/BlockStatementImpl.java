 ...
 * <ul>
 *   <li>{@link edu.ustb.sei.mde.xmu.impl.BlockStatementImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockStatementImpl extends StatementImpl implements BlockStatement {
	...
	protected EClass eStaticClass() {
		return XmuPackage.Literals.BLOCK_STATEMENT;
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this, XmuPackage.BLOCK_STATEMENT__STATEMENTS);
		}
		return statements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XmuPackage.BLOCK_STATEMENT__STATEMENTS:
