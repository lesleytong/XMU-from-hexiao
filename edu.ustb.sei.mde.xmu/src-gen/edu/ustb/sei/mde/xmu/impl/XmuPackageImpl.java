...
public class XmuPackageImpl extends EPackageImpl implements XmuPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getUpdatedStatement_SVar(), this.getObjectVariable(), null, "sVar", null, 1, 1, UpdatedStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
