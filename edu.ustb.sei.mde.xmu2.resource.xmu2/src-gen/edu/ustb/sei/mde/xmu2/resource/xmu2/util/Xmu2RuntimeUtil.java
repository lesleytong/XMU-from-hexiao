...
public class Xmu2RuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
