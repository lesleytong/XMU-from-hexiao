...
public class Xmu2LayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2SyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2GrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2SyntaxElement syntaxElement = edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2GrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2Placeholder) {
			edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2Placeholder placeholder = (edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2Placeholder) syntaxElement;
			edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TokenResolver tokenResolver = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2TokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TokenResolveResult result = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2TokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2LayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
