 ...
 */
public interface IXmu2Options {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getResourcePostProcessorProviderOptionKey();
