...
public class Xmu2DebugTarget extends edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugElement implements org.eclipse.debug.core.model.IDebugTarget, edu.ustb.sei.mde.xmu2.resource.xmu2.debug.IXmu2DebugEventListener {
	
	/**
	 * associated system process
	 */
	private edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugProcess process;
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugThread thread;
	 ...
	 * event listeners
	 */
	private java.util.List<edu.ustb.sei.mde.xmu2.resource.xmu2.debug.IXmu2DebugEventListener> eventListeners = new java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.debug.IXmu2DebugEventListener>();
	
	private edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugProxy debugProxy;
	...
	private class DebugEventDispatcher extends org.eclipse.core.runtime.jobs.Job {
		...
		public DebugEventDispatcher() {
			super(new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getSyntaxName() + " Event Dispatch");
			setSystem(true);
		}
		
		protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
			while (!isTerminated()) {
				edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage message = communicationHelper.receive(eventReader);
				if (message != null) {
		...
		private void notifyListeners(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage message) {
			Object[] listeners = eventListeners.toArray();
			for (int i = 0; i < listeners.length; i++) {
				((edu.ustb.sei.mde.xmu2.resource.xmu2.debug.IXmu2DebugEventListener) listeners[i]).handleMessage(message);
			}
		}
	}
	
	public Xmu2DebugTarget(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugProcess process, org.eclipse.debug.core.ILaunch launch, int requestPort, int eventPort) {
		super(launch.getDebugTarget());
		this.process = process;
		this.launch = launch;
		this.thread = new edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugThread(this);
		this.threads = new org.eclipse.debug.core.model.IThread[] {this.thread};
		
		// initialize debug proxy
		try {
			this.debugProxy = new edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugProxy(this, requestPort);
	 ...
	 */
	public void addEventListener(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.IXmu2DebugEventListener listener) {
	 ...
	 * @param listener event listener
	 */
	public void removeEventListener(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.IXmu2DebugEventListener listener) {
		eventListeners.remove(listener);
	}
	
	public String getName() throws org.eclipse.debug.core.DebugException {
		return new edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2MetaInformation().getSyntaxName() + " model";
	}
		...
		if (supportsBreakpoint(breakpoint)) {
			try {
				if ((breakpoint.isEnabled() && getBreakpointManager().isEnabled()) || !breakpoint.isRegistered()) {
					edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2LineBreakpoint lineBreakpoint = (edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2LineBreakpoint) breakpoint;
	...
	public edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugProxy getDebugProxy() {
