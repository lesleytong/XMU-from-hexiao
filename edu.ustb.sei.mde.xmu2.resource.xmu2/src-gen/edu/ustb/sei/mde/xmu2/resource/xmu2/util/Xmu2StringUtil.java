...
public class Xmu2StringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Function1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Function1<String, T> toStringFunction) {
