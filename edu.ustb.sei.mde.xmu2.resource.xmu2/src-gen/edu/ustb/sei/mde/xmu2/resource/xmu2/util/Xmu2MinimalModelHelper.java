 ...
 */
public class Xmu2MinimalModelHelper {
	
	private final static edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2EClassUtil eClassUtil = new edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2EClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2ListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2ListUtil.castListUnchecked(value);
