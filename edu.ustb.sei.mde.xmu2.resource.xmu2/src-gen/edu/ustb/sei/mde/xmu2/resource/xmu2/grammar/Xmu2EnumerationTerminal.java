 ...
 */
public class Xmu2EnumerationTerminal extends edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2Terminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public Xmu2EnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2Cardinality cardinality, int mandatoryOccurrencesAfter) {
