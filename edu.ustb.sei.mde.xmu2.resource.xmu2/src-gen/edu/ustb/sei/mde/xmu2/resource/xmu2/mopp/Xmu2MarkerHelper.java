 ...
 * contains <code>edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class Xmu2MarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object>> commands = new java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object> command) {
		...
		public void runCommands() {
			java.util.List<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object>> commandsToProcess = new java.util.ArrayList<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextDiagnostic diagnostic) {
		final edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Problem problem = diagnostic.getProblem();
		edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemSeverity.ERROR) {
					...
					edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextDiagnostic textDiagnostic = (edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Resource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Resource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2QuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemType nextType : edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(edu.ustb.sei.mde.xmu2.resource.xmu2.Xmu2EProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2RuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Command<Object>() {
			public boolean execute(Object context) {
				try {
					...
					edu.ustb.sei.mde.xmu2.resource.xmu2.mopp.Xmu2Plugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
