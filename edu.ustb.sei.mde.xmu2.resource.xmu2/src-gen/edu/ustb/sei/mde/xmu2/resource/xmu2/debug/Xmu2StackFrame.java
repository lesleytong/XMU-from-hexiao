...
public class Xmu2StackFrame extends edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugTarget target;
	private String name;
	private int id;
	...
	public Xmu2StackFrame(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.decode(data, ',');
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2StackFrame other = (edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2StackFrame) obj;
		if (name == null) {
