...
/**
 * A IXmu2ReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IXmu2ReferenceResolverSwitch extends edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2Configurable {
