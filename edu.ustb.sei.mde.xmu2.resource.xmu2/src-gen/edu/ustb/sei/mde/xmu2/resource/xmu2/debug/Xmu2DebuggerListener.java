 ...
 * code).
 */
public class Xmu2DebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private edu.ustb.sei.mde.xmu2.resource.xmu2.debug.AbstractXmu2Debuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2Pair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2Pair<String, Object>>();
	...
	public Xmu2DebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.encode('#', stack);
				edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage message = new edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage message = new edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.GET_VARIABLES)) {
				...
				edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage message = new edu.ustb.sei.mde.xmu2.resource.xmu2.debug.Xmu2DebugMessage(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.EXmu2DebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2StringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2Pair<String, Object> pair = new edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2Pair<String, Object>(name, value);
	...
	public edu.ustb.sei.mde.xmu2.resource.xmu2.debug.AbstractXmu2Debuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(edu.ustb.sei.mde.xmu2.resource.xmu2.debug.AbstractXmu2Debuggable debuggable) {
