	...
	public static <K> void putAndMergeKeys(java.util.Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof java.util.List<?>) {
				...
				java.util.List<Object> currentValueAsObjectList = edu.ustb.sei.mde.xmu2.resource.xmu2.util.Xmu2ListUtil.copySafelyToObjectList(currentValueAsList);
