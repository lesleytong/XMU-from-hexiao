 ...
 */
public class Xmu2DefaultTokenResolver implements edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TokenResolver {
	 ...
	 */
	public Xmu2DefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public Xmu2DefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, edu.ustb.sei.mde.xmu2.resource.xmu2.IXmu2TokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : edu.ustb.sei.mde.xmu2.resource.xmu2.grammar.Xmu2GrammarInformationProvider.INSTANCE.getKeywords()) {
