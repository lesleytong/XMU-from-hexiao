 ...
 */
public class Xmu2Plugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "edu.ustb.sei.mde.xmu2.resource.xmu2";
	/**
	...
	private static Xmu2Plugin plugin;
	...
	public static Xmu2Plugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, Xmu2Plugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, Xmu2Plugin.PLUGIN_ID, message);
		}
		final Xmu2Plugin pluginInstance = Xmu2Plugin.getDefault();
