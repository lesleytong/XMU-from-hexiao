...
public class XmuLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.DEBUG_MODEL_ID);
			...
			edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuLineBreakpoint lineBreakpoint = new edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuLineBreakpoint(resource, lineNumber + 1);
