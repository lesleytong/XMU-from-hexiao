 ...
 */
public class XmuNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public XmuNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new xmu file");
