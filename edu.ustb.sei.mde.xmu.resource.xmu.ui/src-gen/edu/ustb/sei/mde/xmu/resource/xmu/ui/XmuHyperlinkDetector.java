 ...
 * hovers, is a proxy.
 */
public class XmuHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public XmuHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
