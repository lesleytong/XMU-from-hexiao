 ...
 */
public class XmuHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public XmuHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
