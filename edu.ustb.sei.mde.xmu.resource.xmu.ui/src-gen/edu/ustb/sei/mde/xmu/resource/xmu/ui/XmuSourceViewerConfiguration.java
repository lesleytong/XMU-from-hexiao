 ...
 */
public class XmuSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public XmuSourceViewerConfiguration(edu.ustb.sei.mde.xmu.resource.xmu.IXmuResourceProvider resourceProvider, edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuAnnotationModelProvider annotationModelProvider, edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuBracketHandlerProvider bracketHandlerProvider, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuColorManager colorManager) {
		super(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
