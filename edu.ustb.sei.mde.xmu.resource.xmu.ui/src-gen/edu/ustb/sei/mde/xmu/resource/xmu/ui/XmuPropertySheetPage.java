...
public class XmuPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEObjectSelection) {
			final edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEObjectSelection selection = (edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEObjectSelection) iSelection;
