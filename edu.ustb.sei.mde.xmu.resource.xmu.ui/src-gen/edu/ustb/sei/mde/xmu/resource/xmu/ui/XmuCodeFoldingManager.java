 ...
 */
public class XmuCodeFoldingManager {
	
	private class FoldingUpdateListener implements edu.ustb.sei.mde.xmu.resource.xmu.IXmuBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor) {
				edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor = (edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor) workbenchPart;
	...
	protected edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor;
	 ...
	 */
	public XmuCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor textEditor) {
	...
	private void addCloseListener(final edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource textResource = (edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
