 ...
 */
public class XmuSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public XmuSyntaxColoringPreferencePage() {
		super();
		
		edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation metaInformation = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPixelConverter pixelConverter = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor) {
			edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor emfTextEditor = (edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor) editor;
