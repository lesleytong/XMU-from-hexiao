 ...
 */
public class XmuHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionHelper positionHelper = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionHelper();
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuTokenScanner scanner;
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuOccurrence occurrence;
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, edu.ustb.sei.mde.xmu.resource.xmu.IXmuBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public XmuHighlighting(edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuColorManager colorManager, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuTokenScanner(textResource, colorManager);
		occurrence = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
