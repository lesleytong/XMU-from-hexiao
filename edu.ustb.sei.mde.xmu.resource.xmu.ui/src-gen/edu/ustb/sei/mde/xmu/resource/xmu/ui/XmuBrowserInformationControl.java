 ...
 * @since 3.2
 */
public class XmuBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuDocBrowserInformationControlInput fInput;
	 ...
	 */
	public XmuBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public XmuBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public XmuBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuDocBrowserInformationControlInput);
		...
		fInput= (edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuDocBrowserInformationControlInput) input;
		...
		edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuDocBrowserInformationControlInput getInput() {
		return fInput;
	}
