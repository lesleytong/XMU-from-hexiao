 ...
 */
public class XmuPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.getDefault().getPreferenceStore());
		setDescription("Xmu Text Editor Preferences");
	}
