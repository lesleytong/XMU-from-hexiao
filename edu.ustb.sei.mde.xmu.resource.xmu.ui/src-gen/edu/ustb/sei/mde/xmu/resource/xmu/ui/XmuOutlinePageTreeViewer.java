 ...
 * a specified depth.
 */
public class XmuOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public XmuOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = edu.ustb.sei.mde.xmu.resource.xmu.util.XmuStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logError("Exception while refreshing outline view", e);
		}
	}
