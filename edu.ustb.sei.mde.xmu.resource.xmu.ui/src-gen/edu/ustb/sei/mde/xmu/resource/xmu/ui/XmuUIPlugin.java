 ...
 */
public class XmuUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "edu.ustb.sei.mde.xmu.resource.xmu.ui";
	public static final String EDITOR_ID = "edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor";
	...
	private static XmuUIPlugin plugin;
	...
	public static XmuUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, XmuUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, XmuUIPlugin.PLUGIN_ID, message);
		}
		final XmuUIPlugin pluginInstance = XmuUIPlugin.getDefault();
