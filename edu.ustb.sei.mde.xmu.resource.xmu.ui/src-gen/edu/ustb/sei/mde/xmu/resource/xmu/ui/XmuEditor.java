...
/**
 * A text editor for 'xmu' models.
 * <p>
 * This editor has id <code>edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor</code>
 * The editor's context menu has id
 * <code>edu.ustb.sei.mde.xmu.resource.xmu.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>edu.ustb.sei.mde.xmu.resource.xmu.EditorRuler</code>.
 * </p>
 */
public class XmuEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, edu.ustb.sei.mde.xmu.resource.xmu.IXmuResourceProvider, edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuBracketHandlerProvider, edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuAnnotationModelProvider {
	
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuCodeFoldingManager codeFoldingManager;
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuBackgroundParsingStrategy bgParsingStrategy = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuBackgroundParsingStrategy();
	private java.util.Collection<edu.ustb.sei.mde.xmu.resource.xmu.IXmuBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.IXmuBackgroundParsingListener>();
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuColorManager colorManager = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuColorManager();
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuOutlinePage outlinePage;
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPropertySheetPage propertySheetPage;
	...
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuBracketHandler bracketHandler;
	...
	public XmuEditor() {
		super();
		setSourceViewerConfiguration(new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), XmuEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource currentResource = getResource();
				...
				edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("edu.ustb.sei.mde.xmu.resource.xmu.EditorContext");
		setRulerContextMenuId("edu.ustb.sei.mde.xmu.resource.xmu.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuNature.activate(inputFile.getProject());
		...
		edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource loadedResource = (edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) {
					setResource((edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the XmuEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource textResource = (edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) element.eResource();
			...
			edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextToken token = lexer.getNextToken();
			...
			edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!XmuEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(edu.ustb.sei.mde.xmu.resource.xmu.IXmuBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (edu.ustb.sei.mde.xmu.resource.xmu.IXmuBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource)) {
					return false;
				}
				edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource textResource = (edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource) resource;
				edu.ustb.sei.mde.xmu.resource.xmu.IXmuLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
