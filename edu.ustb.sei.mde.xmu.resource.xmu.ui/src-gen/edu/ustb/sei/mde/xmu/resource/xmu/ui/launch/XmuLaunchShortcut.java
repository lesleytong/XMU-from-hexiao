 ...
 */
public class XmuLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logError("Exception while launching selection", e);
		}
	}
