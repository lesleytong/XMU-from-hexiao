 ...
 */
public class XmuNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("edu.ustb.sei.mde.xmu.resource.xmu.ui");
							...
							String natureID = edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuNature.NATURE_ID;
							...
							for (String builderID : edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation info = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.getDefault().getBundle();
