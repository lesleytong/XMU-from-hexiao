...
public class XmuBracketSet {
	...
	private java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair {
	 ...
	 */
	private class ClosingListener implements edu.ustb.sei.mde.xmu.resource.xmu.ui.IXmuBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public XmuBracketSet(edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair>();
	 ...
	 */
	public edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair getBracketPair(String opening, String closing) {
		for (edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair bracketPair : bracketPairs) {
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair remove(String opening, String closing) {
		for (edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<edu.ustb.sei.mde.xmu.resource.xmu.IXmuBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
