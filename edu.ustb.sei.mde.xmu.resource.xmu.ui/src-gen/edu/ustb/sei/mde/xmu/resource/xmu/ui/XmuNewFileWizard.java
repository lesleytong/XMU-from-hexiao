...
public class XmuNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public XmuNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName();
	}
