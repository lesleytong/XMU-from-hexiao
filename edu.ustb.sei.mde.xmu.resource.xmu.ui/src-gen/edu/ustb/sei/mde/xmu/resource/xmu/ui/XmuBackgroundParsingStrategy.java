 ...
 */
public class XmuBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource resource, final edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource resource, final edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource resource, final edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource) {
							edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource concreteResource = (edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource) resource;
