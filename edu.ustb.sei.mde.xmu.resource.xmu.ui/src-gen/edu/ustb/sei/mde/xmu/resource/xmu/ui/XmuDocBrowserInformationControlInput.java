 ...
 * olInput</code>.
 */
public class XmuDocBrowserInformationControlInput {
	
	private final XmuDocBrowserInformationControlInput fPrevious;
	private XmuDocBrowserInformationControlInput fNext;
	 ...
	 */
	public XmuDocBrowserInformationControlInput(XmuDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public XmuDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public XmuDocBrowserInformationControlInput getNext() {
		return fNext;
	}
