 ...
 * 
 */
package edu.ustb.sei.mde.xmu.resource.xmu.ui.debug;

@SuppressWarnings("restriction")
public class XmuAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuMetaInformation().getSyntaxName())) {
					return new edu.ustb.sei.mde.xmu.resource.xmu.ui.debug.XmuLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugVariable) {
			final edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugVariable variable = (edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugVariable) {
			final edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugVariable variable = (edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugValue castedValue = (edu.ustb.sei.mde.xmu.resource.xmu.debug.XmuDebugValue) value;
