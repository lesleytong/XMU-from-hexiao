...
public class XmuMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(edu.ustb.sei.mde.xmu.resource.xmu.IXmuOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource) {
					edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource customResource = (edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<edu.ustb.sei.mde.xmu.resource.xmu.IXmuQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final edu.ustb.sei.mde.xmu.resource.xmu.IXmuQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<edu.ustb.sei.mde.xmu.resource.xmu.IXmuQuickFix> getQuickFixes(edu.ustb.sei.mde.xmu.resource.xmu.IXmuTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					edu.ustb.sei.mde.xmu.resource.xmu.IXmuQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
