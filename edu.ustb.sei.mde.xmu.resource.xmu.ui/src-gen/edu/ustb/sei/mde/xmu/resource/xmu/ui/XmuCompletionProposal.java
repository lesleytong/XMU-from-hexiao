 ...
 */
public class XmuCompletionProposal implements java.lang.Comparable<XmuCompletionProposal> {
	 ...
	 */
	private edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuExpectedTerminal expectedTerminal;
	...
	public XmuCompletionProposal(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public XmuCompletionProposal(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public XmuCompletionProposal(edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof XmuCompletionProposal) {
			XmuCompletionProposal other = (XmuCompletionProposal) object;
	...
	public int compareTo(XmuCompletionProposal object) {
		if (object instanceof XmuCompletionProposal) {
			XmuCompletionProposal other = (XmuCompletionProposal) object;
