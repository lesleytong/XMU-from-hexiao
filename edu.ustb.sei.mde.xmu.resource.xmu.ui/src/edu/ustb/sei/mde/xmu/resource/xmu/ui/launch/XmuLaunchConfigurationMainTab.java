 ...
 * 
 */
package edu.ustb.sei.mde.xmu.resource.xmu.ui.launch;

import edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate;
 ...
 * class.
 */
public class XmuLaunchConfigurationMainTab extends org.eclipse.debug.ui.AbstractLaunchConfigurationTab {
	...
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		...
		
		{
			...
			modeButton.setText(XmuLaunchConfigurationDelegate.MODE[0]);
			modeButton.addSelectionListener(new org.eclipse.swt.events.SelectionAdapter() {
				public void widgetSelected(org.eclipse.swt.events.SelectionEvent event) {
					...
					if(mode) {
						...
						modeButton.setText(XmuLaunchConfigurationDelegate.MODE[1]);
					}
					updateLaunchConfigurationDialog();
				}
			});
	...
	public void initializeFrom(org.eclipse.debug.core.ILaunchConfiguration configuration) {
		try {
			resourceUriText.setText(configuration.getAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_RESOURCE_URI, ""));
			sourceUriText.setText(configuration.getAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_SOURCE_URI, ""));
			viewUriText.setText(configuration.getAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_VIEW_URI, ""));
			mode = configuration.getAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_MODE, XmuLaunchConfigurationDelegate.MODE[0]).equals(XmuLaunchConfigurationDelegate.MODE[0]);
			if(mode) modeButton.setText(XmuLaunchConfigurationDelegate.MODE[0]);
			else modeButton.setText(XmuLaunchConfigurationDelegate.MODE[1]);
			// more initialization code can be added here
		} catch (org.eclipse.core.runtime.CoreException e) {
			edu.ustb.sei.mde.xmu.resource.xmu.mopp.XmuPlugin.logError("Can't initialize launch configuration tab.", e);
		}
	}
	
	public void performApply(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_RESOURCE_URI, resourceUriText.getText());
		configuration.setAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_SOURCE_URI, sourceUriText.getText());
		configuration.setAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_VIEW_URI, viewUriText.getText());
		configuration.setAttribute(edu.ustb.sei.mde.xmu.resource.xmu.launch.XmuLaunchConfigurationDelegate.ATTR_MODE, mode?XmuLaunchConfigurationDelegate.MODE[0]:XmuLaunchConfigurationDelegate.MODE[1]);
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		return edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
	}
...
//		});
		...
		dialog.setValidator(new org.eclipse.ui.dialogs.ISelectionStatusValidator() {
			public org.eclipse.core.runtime.IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof org.eclipse.core.resources.IFile)				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.OK, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.OK, "", null);
				
				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, edu.ustb.sei.mde.xmu.resource.xmu.ui.XmuUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.ERROR, "", null);
			}
		});
