 ...
 */
public class MorelNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public MorelNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new morel file");
