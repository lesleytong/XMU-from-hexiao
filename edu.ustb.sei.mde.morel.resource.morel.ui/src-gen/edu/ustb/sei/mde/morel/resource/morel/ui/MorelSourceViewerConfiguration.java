 ...
 */
public class MorelSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public MorelSourceViewerConfiguration(edu.ustb.sei.mde.morel.resource.morel.IMorelResourceProvider resourceProvider, edu.ustb.sei.mde.morel.resource.morel.ui.IMorelAnnotationModelProvider annotationModelProvider, edu.ustb.sei.mde.morel.resource.morel.ui.IMorelBracketHandlerProvider bracketHandlerProvider, edu.ustb.sei.mde.morel.resource.morel.ui.MorelColorManager colorManager) {
		super(edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new edu.ustb.sei.mde.morel.resource.morel.ui.MorelCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new edu.ustb.sei.mde.morel.resource.morel.ui.MorelTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new edu.ustb.sei.mde.morel.resource.morel.ui.MorelTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new edu.ustb.sei.mde.morel.resource.morel.ui.MorelHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new edu.ustb.sei.mde.morel.resource.morel.ui.MorelIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
