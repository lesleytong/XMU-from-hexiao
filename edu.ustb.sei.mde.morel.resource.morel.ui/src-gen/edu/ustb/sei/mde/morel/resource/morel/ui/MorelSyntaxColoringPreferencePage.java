 ...
 */
public class MorelSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public MorelSyntaxColoringPreferencePage() {
		super();
		
		edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation metaInformation = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, edu.ustb.sei.mde.morel.resource.morel.ui.MorelSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		edu.ustb.sei.mde.morel.resource.morel.ui.MorelPixelConverter pixelConverter = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor) {
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor emfTextEditor = (edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor) editor;
