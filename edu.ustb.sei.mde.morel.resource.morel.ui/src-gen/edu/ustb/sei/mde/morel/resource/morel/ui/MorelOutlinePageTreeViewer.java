 ...
 * a specified depth.
 */
public class MorelOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public MorelOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = edu.ustb.sei.mde.morel.resource.morel.util.MorelStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof edu.ustb.sei.mde.morel.resource.morel.ui.MorelEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			edu.ustb.sei.mde.morel.resource.morel.mopp.MorelPlugin.logError("Exception while refreshing outline view", e);
		}
	}
