...
/**
 * A text editor for 'morel' models.
 * <p>
 * This editor has id
 * <code>edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor</code>
 * The editor's context menu has id
 * <code>edu.ustb.sei.mde.morel.resource.morel.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>edu.ustb.sei.mde.morel.resource.morel.EditorRuler</code>.
 * </p>
 */
public class MorelEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, edu.ustb.sei.mde.morel.resource.morel.IMorelResourceProvider, edu.ustb.sei.mde.morel.resource.morel.ui.IMorelBracketHandlerProvider, edu.ustb.sei.mde.morel.resource.morel.ui.IMorelAnnotationModelProvider {
	
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelCodeFoldingManager codeFoldingManager;
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelBackgroundParsingStrategy bgParsingStrategy = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelBackgroundParsingStrategy();
	private java.util.Collection<edu.ustb.sei.mde.morel.resource.morel.IMorelBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<edu.ustb.sei.mde.morel.resource.morel.IMorelBackgroundParsingListener>();
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelColorManager colorManager = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelColorManager();
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelOutlinePage outlinePage;
	...
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelPropertySheetPage propertySheetPage;
	...
	private edu.ustb.sei.mde.morel.resource.morel.ui.IMorelBracketHandler bracketHandler;
	...
	public MorelEditor() {
		super();
		setSourceViewerConfiguration(new edu.ustb.sei.mde.morel.resource.morel.ui.MorelSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), MorelEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource currentResource = getResource();
				...
				edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("edu.ustb.sei.mde.morel.resource.morel.EditorContext");
		setRulerContextMenuId("edu.ustb.sei.mde.morel.resource.morel.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		edu.ustb.sei.mde.morel.resource.morel.mopp.MorelNature.activate(inputFile.getProject());
		...
		edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource loadedResource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) {
					setResource((edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the MorelEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource textResource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) element.eResource();
			edu.ustb.sei.mde.morel.resource.morel.IMorelLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			edu.ustb.sei.mde.morel.resource.morel.IMorelTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				edu.ustb.sei.mde.morel.resource.morel.IMorelTextToken token = lexer.getNextToken();
			...
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!MorelEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(edu.ustb.sei.mde.morel.resource.morel.IMorelBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (edu.ustb.sei.mde.morel.resource.morel.IMorelBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public edu.ustb.sei.mde.morel.resource.morel.ui.IMorelBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(edu.ustb.sei.mde.morel.resource.morel.ui.IMorelBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource)) {
					return false;
				}
				edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource textResource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) resource;
				edu.ustb.sei.mde.morel.resource.morel.IMorelLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
