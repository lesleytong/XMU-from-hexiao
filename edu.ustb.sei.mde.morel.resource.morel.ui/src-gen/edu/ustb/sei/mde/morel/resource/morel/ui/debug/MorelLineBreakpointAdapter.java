...
public class MorelLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(edu.ustb.sei.mde.morel.resource.morel.mopp.MorelPlugin.DEBUG_MODEL_ID);
			...
			edu.ustb.sei.mde.morel.resource.morel.debug.MorelLineBreakpoint lineBreakpoint = new edu.ustb.sei.mde.morel.resource.morel.debug.MorelLineBreakpoint(resource, lineNumber + 1);
