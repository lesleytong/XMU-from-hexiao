...
public class MorelBracketSet {
	...
	private java.util.ArrayList<edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair {
	 ...
	 */
	private class ClosingListener implements edu.ustb.sei.mde.morel.resource.morel.ui.IMorelBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public MorelBracketSet(edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair>();
	 ...
	 */
	public edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair getBracketPair(String opening, String closing) {
		for (edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair bracketPair : bracketPairs) {
	...
	public edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + edu.ustb.sei.mde.morel.resource.morel.ui.MorelPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair remove(String opening, String closing) {
		for (edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<edu.ustb.sei.mde.morel.resource.morel.IMorelBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
