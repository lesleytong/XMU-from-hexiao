 ...
 * hovers, is a proxy.
 */
public class MorelHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public MorelHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
