 ...
 */
public class MorelPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.getDefault().getPreferenceStore());
		setDescription("Morel Text Editor Preferences");
	}
