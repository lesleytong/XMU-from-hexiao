 ...
 */
public class MorelCompletionProposal implements java.lang.Comparable<MorelCompletionProposal> {
	 ...
	 */
	private edu.ustb.sei.mde.morel.resource.morel.mopp.MorelExpectedTerminal expectedTerminal;
	...
	public MorelCompletionProposal(edu.ustb.sei.mde.morel.resource.morel.mopp.MorelExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public edu.ustb.sei.mde.morel.resource.morel.mopp.MorelExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof MorelCompletionProposal) {
			MorelCompletionProposal other = (MorelCompletionProposal) object;
	...
	public int compareTo(MorelCompletionProposal object) {
		if (object instanceof MorelCompletionProposal) {
			MorelCompletionProposal other = (MorelCompletionProposal) object;
