 ...
 */
public class MorelTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private edu.ustb.sei.mde.morel.resource.morel.IMorelHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput infoInput = (edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					edu.ustb.sei.mde.morel.resource.morel.ui.MorelHyperlink hyperlink = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl iControl = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput) {
							edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput input = (edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl.isAvailable(parent)) {
				edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl iControl = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public MorelTextHover(edu.ustb.sei.mde.morel.resource.morel.IMorelResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				edu.ustb.sei.mde.morel.resource.morel.ui.MorelHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelHTMLPrinter.insertPageProlog(buffer, 0, edu.ustb.sei.mde.morel.resource.morel.ui.MorelTextHover.getStyleSheet());
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelHTMLPrinter.addPageEpilog(buffer);
			return new edu.ustb.sei.mde.morel.resource.morel.ui.MorelDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = edu.ustb.sei.mde.morel.resource.morel.ui.MorelHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return edu.ustb.sei.mde.morel.resource.morel.util.MorelStreamUtil.getContent(styleSheetURL.openStream());
