 ...
 * 
 */
package edu.ustb.sei.mde.morel.resource.morel.ui.debug;

@SuppressWarnings("restriction")
public class MorelAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().getSyntaxName())) {
					return new edu.ustb.sei.mde.morel.resource.morel.ui.debug.MorelLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugVariable) {
			final edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugVariable variable = (edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugVariable) {
			final edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugVariable variable = (edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugValue castedValue = (edu.ustb.sei.mde.morel.resource.morel.debug.MorelDebugValue) value;
