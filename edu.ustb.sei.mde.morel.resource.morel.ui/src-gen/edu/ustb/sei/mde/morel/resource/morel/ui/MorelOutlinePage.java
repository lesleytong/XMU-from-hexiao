 ...
 */
public class MorelOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "edu.ustb.sei.mde.morel.resource.morel.ui.outlinecontext";
	...
	public MorelOutlinePage(edu.ustb.sei.mde.morel.resource.morel.IMorelResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new edu.ustb.sei.mde.morel.resource.morel.ui.MorelOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("edu.ustb.sei.mde.morel.resource.morel.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelOutlinePageActionProvider().getActions(treeViewer);
