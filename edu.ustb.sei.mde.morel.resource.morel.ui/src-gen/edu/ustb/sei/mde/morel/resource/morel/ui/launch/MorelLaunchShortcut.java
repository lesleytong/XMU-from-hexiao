 ...
 */
public class MorelLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(edu.ustb.sei.mde.morel.resource.morel.launch.MorelLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			edu.ustb.sei.mde.morel.resource.morel.mopp.MorelPlugin.logError("Exception while launching selection", e);
		}
	}
