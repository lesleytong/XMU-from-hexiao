 ...
 */
public class MorelUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "edu.ustb.sei.mde.morel.resource.morel.ui";
	public static final String EDITOR_ID = "edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor";
	...
	private static MorelUIPlugin plugin;
	
	public MorelUIPlugin() {
		super();
	}
	...
	public static MorelUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MorelUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, MorelUIPlugin.PLUGIN_ID, message);
		}
		final MorelUIPlugin pluginInstance = MorelUIPlugin.getDefault();
