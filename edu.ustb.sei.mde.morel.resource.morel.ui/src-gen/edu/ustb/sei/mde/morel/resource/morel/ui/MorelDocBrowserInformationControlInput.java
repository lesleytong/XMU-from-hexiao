 ...
 * olInput</code>.
 */
public class MorelDocBrowserInformationControlInput {
	
	private final MorelDocBrowserInformationControlInput fPrevious;
	private MorelDocBrowserInformationControlInput fNext;
	 ...
	 */
	public MorelDocBrowserInformationControlInput(MorelDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public MorelDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public MorelDocBrowserInformationControlInput getNext() {
		return fNext;
	}
