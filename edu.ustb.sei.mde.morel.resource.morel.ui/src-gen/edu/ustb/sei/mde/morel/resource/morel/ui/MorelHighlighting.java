 ...
 */
public class MorelHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionHelper positionHelper = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionHelper();
	...
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelTokenScanner scanner;
	...
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelOccurrence occurrence;
	private edu.ustb.sei.mde.morel.resource.morel.ui.MorelBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, edu.ustb.sei.mde.morel.resource.morel.IMorelBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public MorelHighlighting(edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, edu.ustb.sei.mde.morel.resource.morel.ui.MorelColorManager colorManager, edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelTokenScanner(textResource, colorManager);
		occurrence = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new edu.ustb.sei.mde.morel.resource.morel.ui.MorelBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(edu.ustb.sei.mde.morel.resource.morel.ui.MorelPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, edu.ustb.sei.mde.morel.resource.morel.ui.MorelPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(edu.ustb.sei.mde.morel.resource.morel.ui.MorelPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new edu.ustb.sei.mde.morel.resource.morel.ui.MorelEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
