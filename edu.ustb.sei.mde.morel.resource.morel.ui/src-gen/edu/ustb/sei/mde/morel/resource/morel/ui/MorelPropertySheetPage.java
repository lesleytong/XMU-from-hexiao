...
public class MorelPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof edu.ustb.sei.mde.morel.resource.morel.ui.MorelEObjectSelection) {
			final edu.ustb.sei.mde.morel.resource.morel.ui.MorelEObjectSelection selection = (edu.ustb.sei.mde.morel.resource.morel.ui.MorelEObjectSelection) iSelection;
