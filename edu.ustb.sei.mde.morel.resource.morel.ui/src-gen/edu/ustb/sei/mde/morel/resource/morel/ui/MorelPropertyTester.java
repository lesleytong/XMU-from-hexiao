...
public class MorelPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new edu.ustb.sei.mde.morel.resource.morel.mopp.MorelMetaInformation().getSyntaxName());
	}
