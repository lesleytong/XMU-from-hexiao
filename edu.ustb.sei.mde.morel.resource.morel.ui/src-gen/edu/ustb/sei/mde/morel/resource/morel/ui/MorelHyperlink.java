 ...
 */
public class MorelHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public MorelHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				edu.ustb.sei.mde.morel.resource.morel.mopp.MorelPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
