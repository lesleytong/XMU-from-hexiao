 ...
 */
public class MorelBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource resource, final edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource resource, final edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource resource, final edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof edu.ustb.sei.mde.morel.resource.morel.mopp.MorelResource) {
							edu.ustb.sei.mde.morel.resource.morel.mopp.MorelResource concreteResource = (edu.ustb.sei.mde.morel.resource.morel.mopp.MorelResource) resource;
