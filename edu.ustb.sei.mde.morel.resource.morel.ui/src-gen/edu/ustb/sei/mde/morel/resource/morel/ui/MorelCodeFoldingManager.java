 ...
 */
public class MorelCodeFoldingManager {
	
	private class FoldingUpdateListener implements edu.ustb.sei.mde.morel.resource.morel.IMorelBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor) {
				edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor = (edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor) workbenchPart;
	...
	protected edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor;
	 ...
	 */
	public MorelCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor textEditor) {
	...
	private void addCloseListener(final edu.ustb.sei.mde.morel.resource.morel.ui.MorelEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			edu.ustb.sei.mde.morel.resource.morel.ui.MorelUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource textResource = (edu.ustb.sei.mde.morel.resource.morel.IMorelTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
