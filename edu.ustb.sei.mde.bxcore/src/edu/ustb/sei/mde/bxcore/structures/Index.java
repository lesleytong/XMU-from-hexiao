...
public class Index implements Cloneable {
	...
	public boolean equals(Object index) {
		if(index instanceof Index) {
			...
			//disjoint(c1: Collection, c1: Collection): boolean  如果c1和c2没有共同的元素，则返回真
	...
	public void merge(Index index) {
		if(this==index) return;		//如果是同一个index对象直接返回
		...
		internalIndices.addAll(index.internalIndices);	//将实参的内部索引集添加入调入者的内部索引集
	}
