...
public class GraphChangeTool2_Con {
	...
	public static void changeTypedEdges(ConcurrentTypedGraph graph, int y) {
		...
		TypeNode typeAddressBook = graph.getConcurrentTypeGraph().getTypeNode("AddressBook");
	...
	public static void changeValueEdges(ConcurrentTypedGraph graph, int y) {
		...
		List<PropertyEdge> allPropertyEdges = graph.getConcurrentTypeGraph().getAllPropertyEdges();
	...
	public static void deleteTypedNodes(ConcurrentTypedGraph graph, int y) {
		...
		TypeNode typePerson = graph.getConcurrentTypeGraph().getTypeNode("Person");
	...
	public static void addNodesAndEdges(ConcurrentTypedGraph graph, int z) {
